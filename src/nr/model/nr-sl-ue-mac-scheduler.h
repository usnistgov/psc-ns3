...
public:
  ...
  /**
   * \brief Remove the NR Sidelink logical channel configuration from the scheduler and propagate to the MAC
   *
   * \param lcid logical channel ID
   * \param dstL2Id destination layer 2 ID
   */
  virtual void DoRemoveUeNrSlLcConfigReq (uint8_t lcid, uint32_t dstL2Id) = 0;
...
public:
  ...
  virtual void RemoveUeNrSlLcConfigReq (uint8_t lcid, uint32_t dstL2Id) override;
