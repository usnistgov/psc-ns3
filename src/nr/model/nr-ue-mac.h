...
protected:
   ...
   * \param lcId The Logical Channel id
   */
  void DoRemoveUeNrSlLcConfigCnf (uint8_t lcId);
...
private:
  ...
  /**
   * \brief Remove NR Sidelink destination layer 2 Id
   *
   * Removes destination layer 2 id to the list of destinations.
   * The destinations in this map are sorted w.r.t their
   * logical channel priority. 
   *
   * \param dstL2Id The destination layer 2 ID
   */
  void RemoveNrSlDstL2Id (uint32_t dstL2Id);
