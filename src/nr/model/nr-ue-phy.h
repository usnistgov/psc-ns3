...
private:
 ...
 struct SlRxGrantInfo
 {
   ...
   * \param varTtiInfo the slot VarTti allocation info of the variable TTI
   */
  void SendNrSlFbChannels (const std::list<Ptr<NrSlHarqFeedbackMessage> > & feedbackList, const Time &varTtiPeriod, const NrSlVarTtiAllocInfo &varTtiInfo);
  /**
  ...
  std::list <std::pair<SfnSf, Ptr<NrSlHarqFeedbackMessage> > > m_slHarqFbList;  // List of pending SL HARQ FB messages
};
