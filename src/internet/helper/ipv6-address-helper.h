...
class Ipv6AddressHelper
{
  public:
     ...
     * \param c netdevice container
     * \param addresses a vector of Ipv6Address values which is manually assigned to the respective
     * netdevices \return newly created Ipv6InterfaceContainer
     */
    Ipv6InterfaceContainer AssignManualAddress(const NetDeviceContainer& c,
