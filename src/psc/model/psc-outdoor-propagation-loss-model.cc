...
#include <cmath>
#include "psc-outdoor-propagation-loss-model.h"
#include <ns3/node.h>

NS_LOG_COMPONENT_DEFINE ("PscOutdoorPropagationLossModel");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (PscOutdoorPropagationLossModel);


TypeId
PscOutdoorPropagationLossModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PscOutdoorPropagationLossModel")
    .SetParent<PropagationLossModel> ()
    .AddConstructor<PscOutdoorPropagationLossModel> ()
    .AddAttribute ("Frequency",
                    "The propagation frequency in Hz",
                    DoubleValue (763e6),
                    MakeDoubleAccessor (&PscOutdoorPropagationLossModel::m_frequency),
...
PscOutdoorPropagationLossModel::PscOutdoorPropagationLossModel ()
...
double
PscOutdoorPropagationLossModel::GetLoss (Ptr<MobilityModel> a, Ptr<MobilityModel> b) const
{
  NS_LOG_FUNCTION (this);
...
double 
PscOutdoorPropagationLossModel::DoCalcRxPower (double txPowerDbm,
					       Ptr<MobilityModel> a,
...
int64_t
PscOutdoorPropagationLossModel::DoAssignStreams (int64_t stream)
{
  NS_LOG_FUNCTION (this);
  return 0;
}
