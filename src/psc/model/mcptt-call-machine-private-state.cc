...
void
McpttCallMachinePrivateState::ReceiveAccept(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveAcceptAck(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveMedia(McpttCallMachinePrivate& machine,
                                           const McpttMediaMsg& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateState::ReceiveReject(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveRelease(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveReleaseAck(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveRinging(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateState::ReceiveSetupRequest(McpttCallMachinePrivate& machine,
...
void
McpttCallMachinePrivateStateP0::ReceiveSetupRequest(McpttCallMachinePrivate& machine,
                                                    const McpttCallMsgPrivateSetupReq& msg)
{
    NS_LOG_FUNCTION(this << &msg);
        ...
        if (theirCalleeId.GetId() == myUserId)
        {
            ...
            else // Media session CAN be established
            {
                ...
                else if (commMode.GetMode() == McpttCallMsgFieldCommMode::MANUAL_MODE)
                {
                    ...
                    // TODO: Not in standard - When user accepts call need SDP to establish
                    // connection
                    machine.SetSdp(theirSdp);
                    ...
                    Simulator::Schedule(Seconds(0),
                                        &McpttCallMachinePrivate::NotifyNewCall,
                                        &machine,
                                        theirCallId.GetCallId());
                }
            }
        }
    }
...
void
McpttCallMachinePrivateStateP1::ReceiveRelease(McpttCallMachinePrivate& machine,
                                               const McpttCallMsgPrivateRelease& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP1::ReceiveSetupRequest(McpttCallMachinePrivate& machine,
                                                    const McpttCallMsgPrivateSetupReq& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP2::ReceiveAccept(McpttCallMachinePrivate& machine,
                                              const McpttCallMsgPrivateAccept& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP2::ReceiveReject(McpttCallMachinePrivate& machine,
                                              const McpttCallMsgPrivateReject& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP2::ReceiveRinging(McpttCallMachinePrivate& machine,
                                               const McpttCallMsgPrivateRinging& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP3::ReceiveReleaseAck(McpttCallMachinePrivate& machine,
                                                  const McpttCallMsgPrivateReleaseAck& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP4::ReceiveRelease(McpttCallMachinePrivate& machine,
                                               const McpttCallMsgPrivateRelease& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP5::ReceiveAcceptAck(McpttCallMachinePrivate& machine,
                                                 const McpttCallMsgPrivateAcceptAck& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP5::ReceiveMedia(McpttCallMachinePrivate& machine,
                                             const McpttMediaMsg& msg)
{
    NS_LOG_FUNCTION(this << &msg);
...
void
McpttCallMachinePrivateStateP5::ReceiveRelease(McpttCallMachinePrivate& machine,
                                               const McpttCallMsgPrivateRelease& msg)
{
    NS_LOG_FUNCTION(this << &msg);
