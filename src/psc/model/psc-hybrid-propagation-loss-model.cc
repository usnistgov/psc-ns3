...
#include <cmath>
#include "psc-hybrid-propagation-loss-model.h"
#include "ns3/mobility-building-info.h"
#include "ns3/node.h"

NS_LOG_COMPONENT_DEFINE ("PscHybridPropagationLossModel");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (PscHybridPropagationLossModel);


TypeId
PscHybridPropagationLossModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::PscHybridPropagationLossModel")
    .SetParent<PropagationLossModel> ()
    .AddConstructor<PscHybridPropagationLossModel> ()
    .AddAttribute ("Frequency",
                    "The propagation frequency in Hz",
                    DoubleValue (763e6),
                    MakeDoubleAccessor (&PscHybridPropagationLossModel::m_frequency),
...
PscHybridPropagationLossModel::PscHybridPropagationLossModel ()
...
double
PscHybridPropagationLossModel::GetLoss (Ptr<MobilityModel> a, Ptr<MobilityModel> b) const
{
  NS_LOG_FUNCTION (this);
...
double 
PscHybridPropagationLossModel::DoCalcRxPower (double txPowerDbm,
					       Ptr<MobilityModel> a,
...
int64_t
PscHybridPropagationLossModel::DoAssignStreams (int64_t stream)
{
  NS_LOG_FUNCTION (this);
  return 0;
}
