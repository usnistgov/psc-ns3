...
#ifndef PSC_SCM_URBANMACROCELL_PROPAGATION_LOSS_MODEL_H
#define PSC_SCM_URBANMACROCELL_PROPAGATION_LOSS_MODEL_H
 ...
 * 
 */
class PscScmUrbanmacrocellPropagationLossModel : public BuildingsPropagationLossModel
{
...
public:
  ...
  PscScmUrbanmacrocellPropagationLossModel ();
  virtual ~PscScmUrbanmacrocellPropagationLossModel ();
...
#endif // PSC_SCM_URBANMACROCELL_PROPAGATION_LOSS_MODEL_H
