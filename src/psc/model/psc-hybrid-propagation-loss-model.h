...
#ifndef PSC_HYBRID_PROPAGATION_LOSS_MODEL_H
#define PSC_HYBRID_PROPAGATION_LOSS_MODEL_H
 ...
 */
class PscHybridPropagationLossModel : public PropagationLossModel
{
...
public:
  ...
  PscHybridPropagationLossModel ();
  virtual ~PscHybridPropagationLossModel ();
...
#endif // PSC_HYBRID_PROPAGATION_LOSS_MODEL_H
