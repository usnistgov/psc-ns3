...
void
McpttCallMachineGrpBasicState::ReceiveGrpCallAccept(McpttCallMachineGrpBasic& machine,
...
void
McpttCallMachineGrpBasicState::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
...
void
McpttCallMachineGrpBasicState::ReceiveGrpCallProbe(McpttCallMachineGrpBasic& machine,
...
{
    static Ptr<McpttCallMachineGrpBasicStateS1> instance =
        Create<McpttCallMachineGrpBasicStateS1>();
    return instance;
}
...
void
McpttCallMachineGrpBasicStateS1::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAnnoun& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
    ...
    if (myGrpId.GetGrpId() == theirGrpId.GetGrpId())
    {
        ...
        if (userAckReq)
        {
            ...
            Simulator::Schedule(Seconds(0),
                                &McpttCallMachineGrpBasic::NotifyNewCall,
                                &machine,
...
{
    static Ptr<McpttCallMachineGrpBasicStateS2> instance =
        Create<McpttCallMachineGrpBasicStateS2>();
    return instance;
}
...
void
McpttCallMachineGrpBasicStateS2::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAnnoun& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
...
{
    static Ptr<McpttCallMachineGrpBasicStateS3> instance =
        Create<McpttCallMachineGrpBasicStateS3>();
...
void
McpttCallMachineGrpBasicStateS3::ReceiveGrpCallAccept(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAccept& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
...
void
McpttCallMachineGrpBasicStateS3::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAnnoun& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
              ...
              myCallId.GetCallId() != theirCallId.GetCallId()))
    {
        ...
        if (clause1 || clause2 || clause3 || clause4)
        {
            ...
            Simulator::Schedule(Seconds(0),
                                &McpttCallMachineGrpBasic::NotifyMerge,
                                &machine,
                                theirCallId.GetCallId());
...
void
McpttCallMachineGrpBasicStateS3::ReceiveGrpCallProbe(McpttCallMachineGrpBasic& machine,
                                                     const McpttCallMsgGrpProbe& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
...
McpttCallMachineGrpBasicStateS3::ReleaseCall(McpttCallMachineGrpBasic& machine)
{
    ...
    // TODO: Not in standard - stopping timer TFG6 when the call is released (i.e. when leaving the
    // S3 state).
    tfg6->Stop();
...
{
    static Ptr<McpttCallMachineGrpBasicStateS4> instance =
        Create<McpttCallMachineGrpBasicStateS4>();
...
{
    static McpttEntityId stateId =
        McpttEntityId(4, "'S4: pending user action without confirm indication'");
...
{
    static Ptr<McpttCallMachineGrpBasicStateS5> instance =
        Create<McpttCallMachineGrpBasicStateS5>();
...
{
    static McpttEntityId stateId =
        McpttEntityId(5, "'S5: pending user action with confirm indication'");
...
{
    static Ptr<McpttCallMachineGrpBasicStateS6> instance =
        Create<McpttCallMachineGrpBasicStateS6>();
...
void
McpttCallMachineGrpBasicStateS6::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAnnoun& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
...
{
    static Ptr<McpttCallMachineGrpBasicStateS7> instance =
        Create<McpttCallMachineGrpBasicStateS7>();
...
{
    static McpttEntityId stateId =
        McpttEntityId(7, "'S7: waiting for call announcement after call release'");
...
void
McpttCallMachineGrpBasicStateS7::ReceiveGrpCallAnnoun(McpttCallMachineGrpBasic& machine,
                                                      const McpttCallMsgGrpAnnoun& msg)
{
    NS_LOG_FUNCTION(this << &machine << msg);
