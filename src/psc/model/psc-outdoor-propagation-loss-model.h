...
#ifndef PSC_OUTDOOR_PROPAGATION_LOSS_MODEL_H
#define PSC_OUTDOOR_PROPAGATION_LOSS_MODEL_H
 ...
 */
class PscOutdoorPropagationLossModel : public PropagationLossModel
{
...
public:
  ...
  PscOutdoorPropagationLossModel ();
  virtual ~PscOutdoorPropagationLossModel ();
...
#endif // PSC_OUTDOOR_PROPAGATION_LOSS_MODEL_H
