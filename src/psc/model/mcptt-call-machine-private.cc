...
McpttCallMachinePrivate::GetTypeId()
{
    ...
    static TypeId tid =
        TypeId("ns3::psc::McpttCallMachinePrivate")
            .SetParent<McpttCallMachineGrp>()
            .AddConstructor<McpttCallMachinePrivate>()
            .AddAttribute("AutoCommencement",
                          "The flag that indicates if auto commencement mode should be indicated.",
                          BooleanValue(true),
...
McpttCallMachinePrivate::GetCallTypeMachine() const
{
    ...
    Ptr<McpttCallTypeMachine> typeMachine =
        DynamicCast<McpttCallTypeMachine, McpttCallTypeMachinePrivate>(grpTypeMachine);
...
McpttCallMachinePrivate::InitiateCall()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << " initiating private call.");
...
McpttCallMachinePrivate::IsAutoCommencement() const
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 ...
                 << (m_autoCommencement ? "" : "NOT ") << "desire auto commencement.");
...
McpttCallMachinePrivate::IsFailure() const
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << " can "
                 << (m_failure ? "NOT " : "") << "establish call.");
...
McpttCallMachinePrivate::ExpiryOfTfp1()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP1 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp2()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP2 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp3()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP3 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp4()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP4 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp5()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP5 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp6()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP6 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp7()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP7 timer expired.");
...
McpttCallMachinePrivate::ExpiryOfTfp8()
{
    ...
    NS_LOG_LOGIC(GetInstanceTypeId().GetName()
                 << " " << GetCall()->GetOwner()->GetUserId() << "'s TFP8 timer expired.");
...
void
McpttCallMachinePrivate::SetStateChangeCb(
