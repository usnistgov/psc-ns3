          ...
          if (!machine.GetOwner ()->IsFloorOccupied ())
            {
              ...
              machine.GetOwner ()->Receive (reqMsg);
              McpttOnNetworkFloorTowardsParticipantStatePermitted::GetInstance ()->Enter (machine);
            }
