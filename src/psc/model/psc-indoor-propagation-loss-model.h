...
#ifndef PSC_INDOOR_PROPAGATION_LOSS_MODEL_H
#define PSC_INDOOR_PROPAGATION_LOSS_MODEL_H
 ...
 */
class PscIndoorPropagationLossModel : public PropagationLossModel
{
...
public:
  ...
  PscIndoorPropagationLossModel ();
  virtual ~PscIndoorPropagationLossModel ();
...
#endif // PSC_INDOOR_PROPAGATION_LOSS_MODEL_H
