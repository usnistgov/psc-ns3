...
void
McpttOnNetworkFloorArbitratorState::CallInitialized(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
...
void
McpttOnNetworkFloorArbitratorState::ReceiveFloorRelease(Ptr<McpttOnNetworkFloorArbitrator> machine,
...
void
McpttOnNetworkFloorArbitratorState::ReceiveFloorRequest(Ptr<McpttOnNetworkFloorArbitrator> machine,
...
void
McpttOnNetworkFloorArbitratorState::ReceiveMedia(Ptr<McpttOnNetworkFloorArbitrator> machine,
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateStartStop> instance =
        Create<McpttOnNetworkFloorArbitratorStateStartStop>();
    return instance;
}
...
void
McpttOnNetworkFloorArbitratorStateStartStop::CallInitialized(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
    Ptr<McpttOnNetworkFloorTowardsParticipant> participant) const
{
    NS_LOG_FUNCTION(this << machine << participant);
    ...
    else
    {
        if (participant->IsImplicitRequest())
        {
            ...
            McpttOnNetworkFloorArbitratorStateIdle::GetInstance()->ReceiveFloorRequest(machine,
                                                                                       msg);
        }
        else
        {
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateIdle> instance =
        Create<McpttOnNetworkFloorArbitratorStateIdle>();
    return instance;
}
...
McpttOnNetworkFloorArbitratorStateIdle::Enter(Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
             ...
             machine->IsDualFloor())
    {
        ...
        takenMsg.SetPartyId(
            McpttFloorMsgFieldGrantedPartyId(machine->GetDualControl()->GetStoredSsrc()));
...
void
McpttOnNetworkFloorArbitratorStateIdle::ReceiveFloorRequest(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
    const McpttFloorMsgRequest& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
    ...
    if (isOnlyParticipant || isRxOnly)
    {
        ...
        {
            denyMsg.SetRejCause(
                McpttFloorMsgFieldRejectCause(McpttFloorMsgFieldRejectCause::CAUSE_3));
        }
        else if (isRxOnly)
        {
            denyMsg.SetRejCause(
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateTaken> instance =
        Create<McpttOnNetworkFloorArbitratorStateTaken>();
    return instance;
}
...
McpttOnNetworkFloorArbitratorStateTaken::Enter(Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    ...
    grantedMsg.SetDuration(
        McpttFloorMsgFieldDuration(machine->GetT2()->GetTimeLeft().GetSeconds()));
    ...
    if (machine->GetOwner()->GetCallMachine()->GetCallType().GetType() ==
...
void
McpttOnNetworkFloorArbitratorStateTaken::ExpiryOfT1(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ExpiryOfT2(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ReceiveMedia(Ptr<McpttOnNetworkFloorArbitrator> machine,
                                                      const McpttMediaMsg& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ReceiveFloorRelease(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
    const McpttFloorMsgRelease& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ReceiveFloorRequest(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
    const McpttFloorMsgRequest& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ExpiryOfT20(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
...
void
McpttOnNetworkFloorArbitratorStateTaken::ClientRelease(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this);
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateRevoke> instance =
        Create<McpttOnNetworkFloorArbitratorStateRevoke>();
    return instance;
}
...
void
McpttOnNetworkFloorArbitratorStateRevoke::ReceiveMedia(Ptr<McpttOnNetworkFloorArbitrator> machine,
                                                       const McpttMediaMsg& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
...
void
McpttOnNetworkFloorArbitratorStateRevoke::ReceiveFloorRelease(
    Ptr<McpttOnNetworkFloorArbitrator> machine,
    const McpttFloorMsgRelease& msg) const
{
    NS_LOG_FUNCTION(this << machine << msg);
...
void
McpttOnNetworkFloorArbitratorStateRevoke::ExpiryOfT3(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
...
void
McpttOnNetworkFloorArbitratorStateRevoke::ExpiryOfT1(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateReleasing> instance =
        Create<McpttOnNetworkFloorArbitratorStateReleasing>();
    return instance;
}
...
void
McpttOnNetworkFloorArbitratorStateReleasing::CallRelease2(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this);
...
{
    static Ptr<McpttOnNetworkFloorArbitratorStateInitialising> instance =
        Create<McpttOnNetworkFloorArbitratorStateInitialising>();
    return instance;
}
...
void
McpttOnNetworkFloorArbitratorStateInitialising::Enter(
    Ptr<McpttOnNetworkFloorArbitrator> machine) const
{
    NS_LOG_FUNCTION(this << machine);
