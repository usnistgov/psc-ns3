...
class SchoolShootingApplicationHelper : public Object
{
  public:
    ...
    enum SchoolSchootingApplicationId : PscScenarioDefinition::ApplicationId
    {
        ...
        SCHOOL_SHOOTING_THROW_PHONE_VIDEO, // Used only to identify throw phone video trace output
                                           // stream
        SCHOOL_SHOOTING_VIDEO_CONFERENCE_VIDEO, // Used only to identify audio conference video
                                                // trace output stream
        SCHOOL_SHOOTING_VIDEO_CONFERENCE_AUDIO // Used only to identify audio conference audio trace
                                               // output stream
    };
