...
class SchoolShootingApplicationTraceHelper : public Object
{
  public:
     ...
     */
    static void TraceAppTime(Ptr<OutputStreamWrapper> appOutputStreamWrapper,
                             std::string appName,
                             Time startTime,
                             Time stopTime);
     ...
     * \param name Name of application to trace
     */
    void EnablePscAppsTrafficTrace(
     ...
     */
    static void TraceAppRxTraffic(Ptr<OutputStreamWrapper> appOutputStreamWrapper,
                                  std::string appName,
     ...
     * \param header The header of the packet being traced
     */
    static void TraceAppTxTraffic(Ptr<OutputStreamWrapper> appOutputStreamWrapper,
                                  std::string appName,
                                  SeqTsSizeHeader header);
     ...
     */
    static void TraceTxSwatHelmetCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p);
     ...
     */
    static void TraceRxSwatHelmetCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p,
     ...
     * \param p The packet sent
     */
    static void TraceTxDeployableCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxDeployableCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p,
                                        const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxThrowPhoneCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxThrowPhoneCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p,
                                        const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxHelicopterCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxHelicopterCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p,
                                        const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxEmsVehicleCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxEmsVehicleCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                        Ptr<Node> node,
                                        Ptr<const Packet> p,
                                        const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxVideoConferenceVideo(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                            Ptr<Node> node,
                                            Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxVideoConferenceVideo(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                            Ptr<Node> node,
                                            Ptr<const Packet> p,
                                            const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxSchoolCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                    Ptr<Node> node,
                                    Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxSchoolCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                    Ptr<Node> node,
                                    Ptr<const Packet> p,
                                    const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxTrafficCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                     Ptr<Node> node,
                                     Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxTrafficCamera(Ptr<OutputStreamWrapper> outputStreamWrapper,
                                     Ptr<Node> node,
                                     Ptr<const Packet> p,
                                     const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxWeb(Ptr<OutputStreamWrapper> outputStreamWrapper,
                           Ptr<Node> node,
                           Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxWeb(Ptr<OutputStreamWrapper> outputStreamWrapper,
                           Ptr<Node> node,
                           Ptr<const Packet> p,
                           const Address& srcAddrs);
     ...
     * \param p The packet sent
     */
    static void TraceTxNg911(Ptr<OutputStreamWrapper> outputStreamWrapper,
                             Ptr<Node> node,
                             Ptr<const Packet> p);
     ...
     * \param srcAddrs The address of the sender
     */
    static void TraceRxNg911(Ptr<OutputStreamWrapper> outputStreamWrapper,
                             Ptr<Node> node,
                             Ptr<const Packet> p,
                             const Address& srcAddrs);
  ...
  private:
     ...
     */
    std::map<SchoolShootingApplicationHelper::SchoolSchootingApplicationId,
             Ptr<OutputStreamWrapper>>
        m_outputStreamWrappers;
    ...
    std::map<SchoolShootingApplicationHelper::SchoolSchootingApplicationId,
             Ptr<OutputStreamWrapper>>
        m_appTrafficOutputStreamWrappers;
