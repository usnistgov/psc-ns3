...
{
    static TypeId tid =
        TypeId("ns3::psc::SchoolShootingDefinitionHelper")
            .SetParent<Object>()
...
SchoolShootingDefinitionHelper::CreateScenario(std::string name)
{
    ...
    InitStructures();
    InitKeyEvents();
    InitNodesAndMobility(); // make sure this is done after populating the key events in case
                            // mobility depends on the events
}
...
void
SchoolShootingDefinitionHelper::InitAreas()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitStructures()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitKeyEvents()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitNodesAndMobility()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitializeUC()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitializeSwatTeams()
{
    NS_LOG_FUNCTION(this);
    ...
    // DC 1
    Ptr<WaypointMobilityModel> waypointMmDC1 =
        deployableCameras.Get(0)->GetObject<WaypointMobilityModel>();
    ...
    // DC 2
    Ptr<WaypointMobilityModel> waypointMmDC2 =
        deployableCameras.Get(1)->GetObject<WaypointMobilityModel>();
    ...
    // DC 3
    Ptr<WaypointMobilityModel> waypointMmDC3 =
        deployableCameras.Get(2)->GetObject<WaypointMobilityModel>();
    ...
    // DC 4
    Ptr<WaypointMobilityModel> waypointMmDC4 =
        deployableCameras.Get(3)->GetObject<WaypointMobilityModel>();
    ...
    team1MobilityHelper.SetMemberMobilityModel(
        "ns3::RandomWalk2dMobilityModel",
        "Bounds",
        RectangleValue(Rectangle(-2, 2, -2, 2)),
        "Speed",
    ...
    team2MobilityHelper.SetMemberMobilityModel(
        "ns3::RandomWalk2dMobilityModel",
        "Bounds",
        RectangleValue(Rectangle(-2, 2, -2, 2)),
        "Speed",
    ...
    team3MobilityHelper.SetMemberMobilityModel(
        "ns3::RandomWalk2dMobilityModel",
        "Bounds",
        RectangleValue(Rectangle(-2, 2, -2, 2)),
        "Speed",
    ...
    team4MobilityHelper.SetMemberMobilityModel(
        "ns3::RandomWalk2dMobilityModel",
        "Bounds",
        RectangleValue(Rectangle(-2, 2, -2, 2)),
        "Speed",
...
void
SchoolShootingDefinitionHelper::InitializeTaskForce()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitializeFireEms()
{
...
void
SchoolShootingDefinitionHelper::InitializeHelicopter()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitializeSchoolAndTrafficCameras()
{
    NS_LOG_FUNCTION(this);
...
void
SchoolShootingDefinitionHelper::InitializeOffender()
{
    NS_LOG_FUNCTION(this);
...
double
SchoolShootingDefinitionHelper::AddWayPoint(Ptr<WaypointMobilityModel> waypointMm,
                                            double t,
                                            Vector pos,
                                            double waitTime)
{
