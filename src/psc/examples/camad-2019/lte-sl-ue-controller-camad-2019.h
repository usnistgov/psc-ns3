...
class LteSlUeControllerCamad2019 : public LteSlUeController
{
  public:
     ...
     */
    typedef void (*DiscoveryEventTracedCallback)(const uint32_t remoteId,
                                                 const uint32_t relayId,
                                                 const double timeToDisc,
                                                 const uint32_t nPeriodstoDisc);
     ...
     */
    typedef void (*RemoteConnectionStartTracedCallback)(const uint32_t remoteId,
                                                        const uint32_t relayId,
     ...
     */
    typedef void (*RemoteConnectionEstablishedTracedCallback)(const uint32_t remoteId,
                                                              const uint32_t relayId,
                                                              const uint32_t connectionCount,
                                                              const double timeToConnect);
  ...
  protected:
    ...
    virtual void DoPc5ConnectionStarted(uint32_t remoteUeId,
                                        uint32_t selfUeId,
                                        LteSlUeRrc::RelayRole role);
    virtual void DoPc5SecuredEstablished(uint32_t remoteUeId,
                                         uint32_t selfUeId,
                                         LteSlUeRrc::RelayRole role);
    virtual void DoPc5ConnectionTerminated(uint32_t remoteUeId,
                                           uint32_t selfUeId,
                                           LteSlUeRrc::RelayRole role);
