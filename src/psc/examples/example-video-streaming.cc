 ...
 * - maxUdpPayloadSize: maximum UDP payload size [12, 65500] (default: 1500)
 */
...
main(int argc, char* argv[])
{
    ...
    uint16_t maxUdpPayloadSize = 1472;
    ...
    {
        std::cerr << "Error, maximum UDP payload size must be between 12 and 65500 (inclusive), "
                     "but user requested "
