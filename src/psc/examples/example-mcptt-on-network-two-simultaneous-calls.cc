...
void
EventTrace(uint32_t userId, uint16_t callId, const std::string& selected, const char* description)
{
    std::cout << Simulator::Now().GetSeconds() << " userId " << userId << " callId " << callId
...
main(int argc, char* argv[])
{
    ...
    // p2ph.EnablePcap("example-mcptt-on-network-two-simultaneous-calls.ims.pcap",
