...
{
    static TypeId tid =
        TypeId("ns3::psc::PscApplicationHelper")
            .SetParent<Object>()
...
PscApplicationHelper::Install(Ptr<PscApplicationConfiguration> config,
                              Ptr<Node> client,
                              Ptr<Node> server,
...
Ptr<Application>
PscApplicationHelper::InstallClientPriv(Ptr<PscApplicationConfiguration> config, Ptr<Node> client)
{
...
Ptr<Application>
PscApplicationHelper::InstallServerPriv(Ptr<Node> server)
{
