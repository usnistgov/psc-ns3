...
#ifndef NIST_TDMT_FF_MAC_SCHEDULER_H
#define NIST_TDMT_FF_MAC_SCHEDULER_H
...
class NistTdMtFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistTdMtFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistTdMtFfMacScheduler ();
  ...
  friend class NistTdMtSchedulerMemberCschedSapProvider;
  friend class NistTdMtSchedulerMemberSchedSapProvider;
...
#endif /* NIST_TDMT_FF_MAC_SCHEDULER_H */
