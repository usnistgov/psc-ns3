...
#ifndef NIST_TDBET_FF_MAC_SCHEDULER_H
#define NIST_TDBET_FF_MAC_SCHEDULER_H
...
class NistTdBetFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistTdBetFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistTdBetFfMacScheduler ();
  ...
  friend class NistTdBetSchedulerMemberCschedSapProvider;
  friend class NistTdBetSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NisttdbetsFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NisttdbetsFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_TDBET_FF_MAC_SCHEDULER_H */
