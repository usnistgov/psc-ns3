...
#ifndef NIST_CQA_FF_MAC_SCHEDULER_H
#define NIST_CQA_FF_MAC_SCHEDULER_H
...
class NistCqaFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistCqaFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistCqaFfMacScheduler ();
  ...
  friend class NistCqaSchedulerMemberCschedSapProvider;
  friend class NistCqaSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistCqasFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NistCqasFlowPerf_t> m_flowStatsUl;
