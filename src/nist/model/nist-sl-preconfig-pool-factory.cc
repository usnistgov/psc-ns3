...
NS_LOG_COMPONENT_DEFINE ("NistSlPreconfigPoolFactory");

NistSlPreconfigPoolFactory::NistSlPreconfigPoolFactory ()
{
  m_scCpLen = "NORMAL";
  m_period = "sf40";
  m_scPrbNum = 22;
...
NistLteRrcSap::SlPreconfigCommPool
NistSlPreconfigPoolFactory::CreatePool ()
{
  // Control
  //pool.scCpLen.cplen = NistLteRrcSap::SlCpLen::NORMAL;
  ...
  //pool.scPeriod.period = NistLteRrcSap::SlPeriodComm::sf40;
  ...
  //data
  //pool.dataCpLen.cplen = NistLteRrcSap::SlCpLen::NORMAL;
  ...
  //pool.dataHoppingConfig.numSubbands = NistLteRrcSap::SlHoppingConfigComm::ns4;
  ...
  if (m_txAlpha == "al0") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al0;}
  else if (m_txAlpha == "al04") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al04;}
  else if (m_txAlpha == "al05") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al05;}
  else if (m_txAlpha == "al06") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al06;}
  else if (m_txAlpha == "al07") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al07;}
  else if (m_txAlpha == "al08") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al08;}
  else if (m_txAlpha == "al09") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al09;}
  else if (m_txAlpha == "al1") {m_pool.scTxParameters.alpha = NistLteRrcSap::SlTxParameters::al1;}
  ...
  if (m_dataAlpha == "al0") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al0;}
  else if (m_dataAlpha == "al04") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al04;}
  else if (m_dataAlpha == "al05") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al05;}
  else if (m_dataAlpha == "al06") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al06;}
  else if (m_dataAlpha == "al07") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al07;}
  else if (m_dataAlpha == "al08") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al08;}
  else if (m_dataAlpha == "al09") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al09;}
  else if (m_dataAlpha == "al1") {m_pool.dataTxParameters.alpha = NistLteRrcSap::SlTxParameters::al1;}
