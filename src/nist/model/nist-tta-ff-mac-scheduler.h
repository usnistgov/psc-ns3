...
#ifndef NIST_TTA_FF_MAC_SCHEDULER_H
#define NIST_TTA_FF_MAC_SCHEDULER_H
...
class NistTtaFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistTtaFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistTtaFfMacScheduler ();
  ...
  friend class NistTtaSchedulerMemberCschedSapProvider;
  friend class NistTtaSchedulerMemberSchedSapProvider;
...
#endif /* NIST_TTA_FF_MAC_SCHEDULER_H */
