...
#ifndef NIST_LTE_FFR_ALGORITHM_H
#define NIST_LTE_FFR_ALGORITHM_H
...
class NistLteFfrAlgorithm : public Object
{
public:
  NistLteFfrAlgorithm ();
  virtual ~NistLteFfrAlgorithm ();
   ...
   */
  virtual void SetNistLteFfrSapUser (NistLteFfrSapUser* s) = 0;
   ...
   */
  virtual void SetNistLteFfrRrcSapUser (NistLteFfrRrcSapUser* s) = 0;
   ...
   */
  virtual NistLteFfrSapProvider* GetNistLteFfrSapProvider () = 0;
   ...
   */
  virtual NistLteFfrRrcSapProvider* GetNistLteFfrRrcSapProvider () = 0;
...
protected:
  ...
  /**
   * \brief Implementation of NistLteFfrSapProvider::GetAvailableDlRbg
  ...
  /**
   * \brief Implementation of NistLteFfrSapProvider::IsDlRbgAvailableForUe
   * \param rbId
  ...
  /**
   * \brief Implementation of NistLteFfrSapProvider::GetAvailableUlRbg.
  ...
  /**
   * \brief Implementation of NistLteFfrSapProvider::IsUlRbgAvailableForUe.
   * \param rbId
   * \param rnti Radio Network Temporary Identity, an integer identifying the UE
   *             where the report originates from
   * \return true if UE can be served on i-th RB, false otherwise
   ...
   *
   */
  virtual void DoReportDlCqiInfo (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params) = 0;
   ...
   *
   */
  virtual void DoReportUlCqiInfo (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params) = 0;
  ...
  /**
   * \brief Implementation of NistLteFfrRrcSapProvider::SetBandwidth.
  ...
  /**
   * \brief Implementation of NistLteFfrRrcSapProvider::ReportUeMeas.
   * \param rnti Radio Network Temporary Identity, an integer identifying the UE
   *             where the report originates from
   ...
   *
   */
  virtual void DoRecvLoadInformation (NistEpcX2Sap::NistLoadInformationParams params) = 0;
...
}; // end of class NistLteFfrAlgorithm


} // end of namespace ns3


#endif /* NIST_LTE_FFR_ALGORITHM_H */
