...
#ifndef NIST_LTE_FR_STRICT_ALGORITHM_H
#define NIST_LTE_FR_STRICT_ALGORITHM_H
 ...
 */
class NistLteFrStrictAlgorithm : public NistLteFfrAlgorithm
{
public:
  /**
   * \brief Creates a trivial ffr algorithm instance.
   */
  NistLteFrStrictAlgorithm ();

  virtual ~NistLteFrStrictAlgorithm ();
  ...
  friend class MemberNistLteFfrSapProvider<NistLteFrStrictAlgorithm>;
  friend class MemberNistLteFfrRrcSapProvider<NistLteFrStrictAlgorithm>;
...
}; // end of class NistLteFrStrictAlgorithm


} // end of namespace ns3


#endif /* NIST_LTE_FR_STRICT_ALGORITHM_H */
