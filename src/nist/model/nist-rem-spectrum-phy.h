...
#ifndef NIST_REM_SPECTRUM_PHY_H
#define NIST_REM_SPECTRUM_PHY_H
 ...
 */
class NistRemSpectrumPhy : public SpectrumPhy
{

public:
  NistRemSpectrumPhy ();
  virtual ~NistRemSpectrumPhy ();
