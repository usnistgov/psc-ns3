...
#ifndef NIST_PF_FF_MAC_SCHEDULER_H
#define NIST_PF_FF_MAC_SCHEDULER_H
...
class NistPfFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistPfFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistPfFfMacScheduler ();
  ...
  friend class NistPfSchedulerMemberCschedSapProvider;
  friend class NistPfSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> > m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::multimap <uint16_t, std::map <uint8_t, NistPfsFlowPerf_t> > m_flowStatsUl;
...
#endif /* NIST_PF_FF_MAC_SCHEDULER_H */
