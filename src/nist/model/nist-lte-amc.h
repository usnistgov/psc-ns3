...
#ifndef NIST_AMCMODULE_H
#define NIST_AMCMODULE_H
 ...
 */
class NistLteAmc : public Object
{
  ...
  enum AmcModel
    {
      ...
      PiroEW2010,
      /**
       * An AMC model based on 10% of BER according to NistLteMiErrorModel.
       */
      MiErrorModel,
      /**
...
}; // end of `class NistLteAmc`


}

#endif /* NIST_AMCMODULE_H */
