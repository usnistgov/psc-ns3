...
NS_LOG_COMPONENT_DEFINE ("NistLteRlcAmHeader");

NS_OBJECT_ENSURE_REGISTERED (NistLteRlcAmHeader);

NistLteRlcAmHeader::NistLteRlcAmHeader ()
  : m_headerLength (0),
...
void
NistLteRlcAmHeader::SetDataPdu (void)
{
  m_headerLength = 4;
  m_dataControlBit = DATA_PDU;
}
void
NistLteRlcAmHeader::SetControlPdu (uint8_t controlPduType)
{
  m_headerLength = 2;
...
bool
NistLteRlcAmHeader::IsDataPdu (void) const
{
  return (m_dataControlBit == DATA_PDU) ? true : false;
}
bool
NistLteRlcAmHeader::IsControlPdu (void) const
{
  return (m_dataControlBit == CONTROL_PDU) ? true : false;
}

void
NistLteRlcAmHeader::SetFramingInfo (uint8_t framingInfo)
{
  m_framingInfo = framingInfo & 0x03;
}

void
NistLteRlcAmHeader::SetSequenceNumber (NistSequenceNumber10 sequenceNumber)
{
  m_sequenceNumber = sequenceNumber;
}

uint8_t
NistLteRlcAmHeader::GetFramingInfo () const
{
  return m_framingInfo;
}

NistSequenceNumber10
NistLteRlcAmHeader::GetSequenceNumber () const
{
...
void
NistLteRlcAmHeader::PushExtensionBit (uint8_t extensionBit)
{
...
void
NistLteRlcAmHeader::PushLengthIndicator (uint16_t lengthIndicator)
{
...
uint8_t
NistLteRlcAmHeader::PopExtensionBit (void)
{
...
uint16_t
NistLteRlcAmHeader::PopLengthIndicator (void)
{
...
void
NistLteRlcAmHeader::SetResegmentationFlag (uint8_t resegFlag)
{
  m_resegmentationFlag = resegFlag & 0x01;
}

uint8_t
NistLteRlcAmHeader::GetResegmentationFlag () const
{
...
void
NistLteRlcAmHeader::SetPollingBit (uint8_t pollingBit)
{
  m_pollingBit = pollingBit & 0x01;
}

uint8_t
NistLteRlcAmHeader::GetPollingBit (void) const
{
  return m_pollingBit;
}
...
void
NistLteRlcAmHeader::SetLastSegmentFlag (uint8_t lsf)
{
  m_lastSegmentFlag = lsf & 0x01;
}

uint8_t
NistLteRlcAmHeader::GetLastSegmentFlag (void) const
{
...
void
NistLteRlcAmHeader::SetSegmentOffset (uint16_t segmentOffset)
{
  m_segmentOffset = segmentOffset & 0x7FFF;
}

uint16_t
NistLteRlcAmHeader::GetSegmentOffset (void) const
{
  return m_segmentOffset;
}

uint16_t
NistLteRlcAmHeader::GetLastOffset (void) const
{
  return m_lastOffset;
}
...
void
NistLteRlcAmHeader::SetAckSn (NistSequenceNumber10 ackSn)
{
  m_ackSn = ackSn;
}

NistSequenceNumber10
NistLteRlcAmHeader::GetAckSn (void) const
{
  return m_ackSn;
}
...
TypeId
NistLteRlcAmHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistLteRlcAmHeader")
    .SetParent<Header> ()
    .AddConstructor<NistLteRlcAmHeader> ()
  ;
  return tid;
}

TypeId
NistLteRlcAmHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

void
NistLteRlcAmHeader::Print (std::ostream &os)  const
{
...
uint32_t NistLteRlcAmHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void NistLteRlcAmHeader::Serialize (Buffer::Iterator start) const
{
...
uint32_t NistLteRlcAmHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  uint8_t byte_1;
  uint8_t byte_2;
