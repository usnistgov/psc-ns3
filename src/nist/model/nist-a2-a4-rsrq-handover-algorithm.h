...
#ifndef NIST_A2_A4_RSRQ_HANDOVER_ALGORITHM_H
#define NIST_A2_A4_RSRQ_HANDOVER_ALGORITHM_H
 ...
 *
 *     lteHelper->SetHandoverAlgorithmType ("ns3::NistA2A4RsrqHandoverAlgorithm");
 ...
 */
class NistA2A4RsrqHandoverAlgorithm : public NistLteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  NistA2A4RsrqHandoverAlgorithm ();

  virtual ~NistA2A4RsrqHandoverAlgorithm ();
  ...
  friend class MemberNistLteHandoverManagementSapProvider<NistA2A4RsrqHandoverAlgorithm>;
...
}; // end of class NistA2A4RsrqHandoverAlgorithm


} // end of namespace ns3


#endif /* NIST_A2_A4_RSRQ_HANDOVER_ALGORITHM_H */
