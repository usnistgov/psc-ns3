...
#ifndef NIST_LTE_FFR_ENHANCED_ALGORITHM_H
#define NIST_LTE_FFR_ENHANCED_ALGORITHM_H
 ...
 */
class NistLteFfrEnhancedAlgorithm : public NistLteFfrAlgorithm
{
public:
  /**
   * \brief Creates a trivial ffr algorithm instance.
   */
  NistLteFfrEnhancedAlgorithm ();
  virtual ~NistLteFfrEnhancedAlgorithm ();
  ...
  friend class MemberNistLteFfrSapProvider<NistLteFfrEnhancedAlgorithm>;
  friend class MemberNistLteFfrRrcSapProvider<NistLteFfrEnhancedAlgorithm>;
...
private:
  ...
  */
  std::map <uint16_t,NistSbMeasResult_s> m_dlCqi;
...
}; // end of class NistLteFfrEnhancedAlgorithm

} // end of namespace ns3

#endif /* NIST_LTE_FFR_ENHANCED_ALGORITHM_H */
