...
#ifndef NIST_ONOFF_APPLICATION_H
#define NIST_ONOFF_APPLICATION_H
...
*/
class NistOnOffApplication : public Application 
{
public:
  /**
  ...
  NistOnOffApplication ();

  virtual ~NistOnOffApplication();
...
#endif /* NIST_ONOFF_APPLICATION_H */
