...
#ifndef NIST_UDP_SERVER_H
#define NIST_UDP_SERVER_H
 ...
 * \defgroup nistudpclientserver NistUdpClientServer
 */

/**
 * \ingroup nistudpclientserver
 * \class NistUdpServer
 ...
 */
class NistUdpServer : public Application
{
public:
  /**
  ...
  typedef void (* PacketAddressTracedCallback)
    (const Ptr<const Packet> packet, const Address &src_address, const Address &dest_address);
