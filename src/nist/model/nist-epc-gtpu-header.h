...
#ifndef NIST_EPS_GTPU_V1_H
#define NIST_EPS_GTPU_V1_H
 ...
 */
class NistGtpuHeader : public Header
{
public:
  static TypeId GetTypeId (void);
  NistGtpuHeader ();
  virtual ~NistGtpuHeader ();
  ...
  bool operator == (const NistGtpuHeader& b) const;
