...
#ifndef NIST_TRACE_FADING_LOSS_MODEL_H
#define NIST_TRACE_FADING_LOSS_MODEL_H
 ...
 */
class NistTraceFadingLossModel : public SpectrumPropagationLossModel
{
public:
  NistTraceFadingLossModel ();
  virtual ~NistTraceFadingLossModel ();
...
#endif /* NIST_TRACE_FADING_LOSS_MODEL_H */
