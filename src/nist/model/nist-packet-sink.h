...
#ifndef NIST_PACKET_SINK_H
#define NIST_PACKET_SINK_H
 ...
 * \defgroup packetsink NistPacketSink
 *
 * This application was written to complement OnOffApplication, but it
 * is more general so a NistPacketSink name was selected.  Functionally it is
 ...
 */
class NistPacketSink : public Application 
{
public:
  /**
