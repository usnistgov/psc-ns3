...
#ifndef NIST_PSS_FF_MAC_SCHEDULER_H
#define NIST_PSS_FF_MAC_SCHEDULER_H
...
class NistPssFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistPssFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistPssFfMacScheduler ();
  ...
  friend class NistPssSchedulerMemberCschedSapProvider;
  friend class NistPssSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistpssFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NistpssFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_PSS_FF_MAC_SCHEDULER_H */
