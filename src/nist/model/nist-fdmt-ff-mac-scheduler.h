...
#ifndef NIST_FDMT_FF_MAC_SCHEDULER_H
#define NIST_FDMT_FF_MAC_SCHEDULER_H
...
class NistFdMtFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistFdMtFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistFdMtFfMacScheduler ();
  ...
  friend class NistFdMtSchedulerMemberCschedSapProvider;
  friend class NistFdMtSchedulerMemberSchedSapProvider;
...
#endif /* NIST_FDMT_FF_MAC_SCHEDULER_H */
