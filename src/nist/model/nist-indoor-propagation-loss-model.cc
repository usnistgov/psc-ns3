...
NS_LOG_COMPONENT_DEFINE ("NistIndoorPropagationLossModel");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (NistIndoorPropagationLossModel);

TypeId
NistIndoorPropagationLossModel::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::NistIndoorPropagationLossModel")
    .SetParent<PropagationLossModel> ()
    .AddConstructor<NistIndoorPropagationLossModel> ()
    .AddAttribute ("Frequency",
                    "The propagation frequency in Hz",
                    DoubleValue (763e6),
                    MakeDoubleAccessor (&NistIndoorPropagationLossModel::m_frequency),
...
NistIndoorPropagationLossModel::NistIndoorPropagationLossModel ()
...
//Ptr <UniformRandomVariable> NistRandomVariable::s_rand = CreateObject<UniformRandomVariable> ();

std::pair<double, bool> 
NistIndoorPropagationLossModel::GetLoss (Ptr<MobilityModel> a, Ptr<MobilityModel> b) const
{
  bool los = false;
  double loss = 0.0;
...
double 
NistIndoorPropagationLossModel::DoCalcRxPower (double txPowerDbm,
					       Ptr<MobilityModel> a,
...
int64_t
NistIndoorPropagationLossModel::DoAssignStreams (int64_t stream)
{
  return 0;
}
