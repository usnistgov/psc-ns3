...
#ifndef NIST_FDBET_FF_MAC_SCHEDULER_H
#define NIST_FDBET_FF_MAC_SCHEDULER_H
...
class NistFdBetNistFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistFdBetNistFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistFdBetNistFfMacScheduler ();
  ...
  friend class NistFdBetSchedulerMemberCschedSapProvider;
  friend class NistFdBetSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistfdbetsFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NistfdbetsFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_FDBET_FF_MAC_SCHEDULER_H */
