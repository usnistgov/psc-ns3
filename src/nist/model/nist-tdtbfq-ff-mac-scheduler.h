...
#ifndef NIST_TDTBFQ_FF_MAC_SCHEDULER_H
#define NIST_TDTBFQ_FF_MAC_SCHEDULER_H
...
class NistTdTbfqFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistTdTbfqFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistTdTbfqFfMacScheduler ();
  ...
  friend class NistTdTbfqSchedulerMemberCschedSapProvider;
  friend class NistTdTbfqSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NisttdtbfqsFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NisttdtbfqsFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_TDTBFQ_FF_MAC_SCHEDULER_H */
