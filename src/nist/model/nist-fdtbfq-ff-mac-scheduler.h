...
#ifndef NIST_FDTBFQ_FF_MAC_SCHEDULER_H
#define NIST_FDTBFQ_FF_MAC_SCHEDULER_H
...
class NistFdTbfqNistFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistFdTbfqNistFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistFdTbfqNistFfMacScheduler ();
  ...
  friend class NistFdTbfqSchedulerMemberCschedSapProvider;
  friend class NistFdTbfqSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistfdtbfqsFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NistfdtbfqsFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_FDTBFQ_FF_MAC_SCHEDULER_H */
