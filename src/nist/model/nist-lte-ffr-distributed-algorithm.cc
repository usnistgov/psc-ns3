...
NS_LOG_COMPONENT_DEFINE ("NistLteFfrDistributedAlgorithm");

NS_OBJECT_ENSURE_REGISTERED (NistLteFfrDistributedAlgorithm);


NistLteFfrDistributedAlgorithm::NistLteFfrDistributedAlgorithm ()
  : m_ffrSapUser (0),
    m_ffrRrcSapUser (0)
{
  NS_LOG_FUNCTION (this);
  m_ffrSapProvider = new MemberNistLteFfrSapProvider<NistLteFfrDistributedAlgorithm> (this);
  m_ffrRrcSapProvider = new MemberNistLteFfrRrcSapProvider<NistLteFfrDistributedAlgorithm> (this);
}
...
void
NistLteFfrDistributedAlgorithm::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
NistLteFfrDistributedAlgorithm::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::NistLteFfrDistributedAlgorithm")
    .SetParent<NistLteFfrAlgorithm> ()
    .AddConstructor<NistLteFfrDistributedAlgorithm> ()
    .AddAttribute ("CalculationInterval",
                   "Time interval between calculation of Edge sub-band, Default value 1 second",
                   TimeValue (Seconds (1)),
                   MakeTimeAccessor (&NistLteFfrDistributedAlgorithm::m_calculationInterval),
                   MakeTimeChecker ())
    .AddAttribute ("RsrqThreshold",
                   "If the RSRQ of is worse than this threshold, UE should be served in Edge sub-band",
                   UintegerValue (20),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_egdeSubBandRsrqThreshold),
    ...
    .AddAttribute ("RsrpDifferenceThreshold",
                   ...
                   UintegerValue (20),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_rsrpDifferenceThreshold),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("CenterPowerOffset",
                   "NistPdschConfigDedicated::Pa value for Edge Sub-band, default value dB0",
                   UintegerValue (5),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_centerPowerOffset),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgePowerOffset",
                   "NistPdschConfigDedicated::Pa value for Edge Sub-band, default value dB0",
                   UintegerValue (5),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_edgePowerOffset),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeRbNum",
                   "Number of RB that can be used in edge Sub-band",
                   UintegerValue (8),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_edgeRbNum),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("CenterAreaTpc",
                   ...
                   UintegerValue (1),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_centerAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("EdgeAreaTpc",
                   ...
                   "TS36.213 Table 5.1.1.1-2",
                   UintegerValue (1),
                   MakeUintegerAccessor (&NistLteFfrDistributedAlgorithm::m_edgeAreaTpc),
                   MakeUintegerChecker<uint8_t> ())
...
void
NistLteFfrDistributedAlgorithm::SetNistLteFfrSapUser (NistLteFfrSapUser* s)
{
...
NistLteFfrDistributedAlgorithm::GetNistLteFfrSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::SetNistLteFfrRrcSapUser (NistLteFfrRrcSapUser* s)
{
  NS_LOG_FUNCTION (this << s);
  m_ffrRrcSapUser = s;
}
...
NistLteFfrDistributedAlgorithm::GetNistLteFfrRrcSapProvider ()
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::DoInitialize ()
{
  NS_LOG_FUNCTION (this);
  ...
  NistLteRrcSap::NistReportConfigEutra reportConfigA4;
  reportConfigA4.eventId = NistLteRrcSap::NistReportConfigEutra::EVENT_A4;
  reportConfigA4.threshold1.choice = NistLteRrcSap::NistThresholdEutra::THRESHOLD_RSRP;
  reportConfigA4.threshold1.range = 0; // intentionally very low threshold
  reportConfigA4.triggerQuantity = NistLteRrcSap::NistReportConfigEutra::RSRP;
  reportConfigA4.reportInterval = NistLteRrcSap::NistReportConfigEutra::MS120;
  ...
  m_calculationEvent = Simulator::ScheduleNow (&NistLteFfrDistributedAlgorithm::Calculate, this);

}

void
NistLteFfrDistributedAlgorithm::Reconfigure ()
{
  NS_LOG_FUNCTION (this);
  if (m_frCellTypeId != 0)
    {
...
void
NistLteFfrDistributedAlgorithm::SetDownlinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
}

void
NistLteFfrDistributedAlgorithm::SetUplinkConfiguration (uint16_t cellId, uint8_t bandwidth)
{
  NS_LOG_FUNCTION (this);
}

void
NistLteFfrDistributedAlgorithm::InitializeDownlinkRbgMaps ()
{
  NS_LOG_FUNCTION (this);
  m_dlRbgMap.clear ();
  int rbgSize = GetRbgSize (m_dlBandwidth);
...
void
NistLteFfrDistributedAlgorithm::InitializeUplinkRbgMaps ()
{
  NS_LOG_FUNCTION (this);
  m_ulRbgMap.clear ();
...
std::vector <bool>
NistLteFfrDistributedAlgorithm::DoGetAvailableDlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NistLteFfrDistributedAlgorithm::DoIsDlRbgAvailableForUe (int rbgId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
std::vector <bool>
NistLteFfrDistributedAlgorithm::DoGetAvailableUlRbg ()
{
  NS_LOG_FUNCTION (this);
...
bool
NistLteFfrDistributedAlgorithm::DoIsUlRbgAvailableForUe (int rbId, uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::DoReportDlCqiInfo (const struct NistFfMacSchedSapProvider::NistSchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::DoReportUlCqiInfo (const struct NistFfMacSchedSapProvider::NistSchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
void
NistLteFfrDistributedAlgorithm::DoReportUlCqiInfo (std::map <uint16_t, std::vector <double> > ulCqiMap)
{
  NS_LOG_FUNCTION (this);
  NS_LOG_WARN ("Method should not be called, because it is empty");
}
...
uint8_t
NistLteFfrDistributedAlgorithm::DoGetTpc (uint16_t rnti)
{
  NS_LOG_FUNCTION (this);
...
uint8_t
NistLteFfrDistributedAlgorithm::DoGetMinContinuousUlBandwidth ()
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::DoReportUeMeas (uint16_t rnti,
...
void
NistLteFfrDistributedAlgorithm::Calculate ()
{
  NS_LOG_FUNCTION (this);
  m_calculationEvent = Simulator::Schedule (m_calculationInterval, &NistLteFfrDistributedAlgorithm::Calculate, this);
  ...
  Ptr<NistUeMeasure> servingCellMeasures;
  Ptr<NistUeMeasure> neighbourCellMeasures;
...
void
NistLteFfrDistributedAlgorithm::SendLoadInformation (uint16_t targetCellId)
{
  NS_LOG_FUNCTION (this);

  NS_LOG_INFO ("SendLoadInformation to CellId : " << targetCellId );

  std::vector<NistEpcX2Sap::UlInterferenceOverloadIndicationItem> m_currentUlInterferenceOverloadIndicationList;
  std::vector <NistEpcX2Sap::NistUlHighInterferenceInformationItem>  m_currentUlHighInterferenceInformationList;
  NistEpcX2Sap::NistRelativeNarrowbandTxBand m_currentNistRelativeNarrowbandTxBand;

  m_currentNistRelativeNarrowbandTxBand.rntpPerPrbList = m_dlEdgeRbgMap;

  NistEpcX2Sap::NistCellInformationItem cii;
  ...
  cii.relativeNarrowbandTxBand = m_currentNistRelativeNarrowbandTxBand;

  NistEpcX2Sap::NistLoadInformationParams params;
...
void
NistLteFfrDistributedAlgorithm::DoRecvLoadInformation (NistEpcX2Sap::NistLoadInformationParams params)
{
  NS_LOG_FUNCTION (this);
...
void
NistLteFfrDistributedAlgorithm::UpdateNeighbourMeasurements (uint16_t rnti,
                                                         uint16_t cellId,
                                                         uint8_t rsrp,
                                                         uint8_t rsrq)
{
  ...
  Ptr<NistUeMeasure> cellMeasures;
  std::map<uint16_t, Ptr<NistUeMeasure> >::iterator it2;
  ...
  if (it2 != it1->second.end ())
  ...
  else
    {
      ...
      cellMeasures = Create<NistUeMeasure> ();
      cellMeasures->m_cellId = cellId;
      cellMeasures->m_rsrp = rsrp;
      cellMeasures->m_rsrq = rsrq;
