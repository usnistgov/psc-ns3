...
#ifndef NIST_MT_FF_MAC_SCHEDULER_H
#define NIST_MT_FF_MAC_SCHEDULER_H
...
class NistMtFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistMtFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistMtFfMacScheduler ();
  ...
  friend class MtSchedulerMemberCschedSapProvider;
  friend class MtSchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistMtsFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
 std::map <uint16_t, NistMtsFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_MT_FF_MAC_SCHEDULER_H */
