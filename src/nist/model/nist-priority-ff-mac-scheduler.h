...
#ifndef NIST_PRIORITY_FF_MAC_SCHEDULER_H
#define NIST_PRIORITY_FF_MAC_SCHEDULER_H
...
struct NistPrioritysFlowPerf_t
{
  Time flowStart;
...
class NistPriorityFfMacScheduler : public NistFfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  NistPriorityFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~NistPriorityFfMacScheduler ();
  ...
  friend class PrioritySchedulerMemberCschedSapProvider;
  friend class PrioritySchedulerMemberSchedSapProvider;
...
private:
  ...
  */
  std::map <uint16_t, NistPrioritysFlowPerf_t> m_flowStatsDl;

  /*
  * Map of UE statistics (per RNTI basis)
  */
  std::map <uint16_t, NistPrioritysFlowPerf_t> m_flowStatsUl;
...
#endif /* NIST_PRIORITY_FF_MAC_SCHEDULER_H */
