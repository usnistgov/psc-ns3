 ...
 * Modified by: NIST
 */
#ifndef NIST_UDP_ECHO_HELPER_H
#define NIST_UDP_ECHO_HELPER_H
 ...
 */
class NistUdpEchoServerHelper
{
public:
  /**
   * Create NistUdpEchoServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  NistUdpEchoServerHelper (uint16_t port);
 ...
 */
class NistUdpEchoClientHelper
{
public:
  /**
   * Create NistUdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param ip The IP address of the remote udp echo server
   * \param port The port number of the remote udp echo server
   */
  NistUdpEchoClientHelper (Address ip, uint16_t port);
  /**
   * Create NistUdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  NistUdpEchoClientHelper (Ipv4Address ip, uint16_t port);
  /**
   * Create NistUdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   ...
   * \param port The port number of the remote udp echo server
   */
  NistUdpEchoClientHelper (Ipv6Address ip, uint16_t port);
