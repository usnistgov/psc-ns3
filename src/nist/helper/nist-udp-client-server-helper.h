 ...
 * Modified by: NIST
 */
#ifndef NIST_UDP_CLIENT_SERVER_HELPER_H
#define NIST_UDP_CLIENT_SERVER_HELPER_H
 ...
 */
class NistUdpServerHelper
{
public:
  /**
   * Create NistUdpServerHelper which will make life easier for people trying
   ...
   */
  NistUdpServerHelper (uint16_t port);
   ...
   */
  Ptr<NistUdpServer> GetServer (void);
private:
  ObjectFactory m_factory; //!< Object factory.
  Ptr<NistUdpServer> m_server; //!< The last created server application
};
 ...
 *
 */
class NistUdpClientHelper
{

public:
  /**
   * Create NistUdpClientHelper which will make life easier for people trying
  ...
  NistUdpClientHelper (Ipv4Address ip, uint16_t port);
  /**
   *  Create NistUdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  NistUdpClientHelper (Ipv6Address ip, uint16_t port);
  /**
   *  Create NistUdpClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  NistUdpClientHelper (Address ip, uint16_t port);
...
*/
class NistUdpTraceClientHelper
{
public:
  /**
   * Create NistUdpTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   */
  NistUdpTraceClientHelper ();
   ...
   */
  NistUdpTraceClientHelper (Address ip, uint16_t port, std::string filename);
  /**
   * Create NistUdpTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  NistUdpTraceClientHelper (Ipv4Address ip, uint16_t port, std::string filename);
  /**
   * Create NistUdpTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  NistUdpTraceClientHelper (Ipv6Address ip, uint16_t port, std::string filename);
...
#endif /* NIST_UDP_CLIENT_SERVER_H */
