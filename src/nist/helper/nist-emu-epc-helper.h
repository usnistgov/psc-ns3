...
#ifndef NIST_EMU_EPC_HELPER_H
#define NIST_EMU_EPC_HELPER_H
 ...
 */
class NistEmuNistEpcHelper : public NistEpcHelper
{
public:
   ...
   * Constructor
   */
  NistEmuNistEpcHelper ();

  /** 
   * Destructor
   */  
  virtual ~NistEmuNistEpcHelper ();
