...
#ifndef NIST_RADIO_BEARER_STATS_CALCULATOR_H_
#define NIST_RADIO_BEARER_STATS_CALCULATOR_H_
...
typedef std::map<NistImsiLcidPair_t, uint32_t> NistUint32Map;
/// Container: (IMSI, LCID) pair, uint64_t
typedef std::map<NistImsiLcidPair_t, uint64_t> NistUint64Map;
/// Container: (IMSI, LCID) pair, uint32_t calculator
typedef std::map<NistImsiLcidPair_t, Ptr<MinMaxAvgTotalCalculator<uint32_t> > > NistUint32StatsMap;
/// Container: (IMSI, LCID) pair, uint64_t calculator
typedef std::map<NistImsiLcidPair_t, Ptr<MinMaxAvgTotalCalculator<uint64_t> > > NistUint64StatsMap;
/// Container: (IMSI, LCID) pair, double
typedef std::map<NistImsiLcidPair_t, double> NistDoubleMap;
/// Container: (IMSI, LCID) pair, NistLteFlowId_t
typedef std::map<NistImsiLcidPair_t, NistLteFlowId_t> NistFlowIdMap;
 ...
 */
class NistRadioBearerStatsCalculator : public NistLteStatsCalculator
{
public:
  /**
   * Class constructor
   */
  NistRadioBearerStatsCalculator ();

  /**
    * Class constructor
    */
  NistRadioBearerStatsCalculator (std::string protocolType);
...
private:
  ...
  NistFlowIdMap m_flowId; //!< List of FlowIds, ie. (RNTI, LCID) by (IMSI, LCID) pair

  NistUint32Map m_dlCellId; //!< List of DL CellIds by (IMSI, LCID) pair
  NistUint32Map m_dlTxPackets; //!< Number of DL TX Packets by (IMSI, LCID) pair
  NistUint32Map m_dlRxPackets; //!< Number of DL RX Packets by (IMSI, LCID) pair
  NistUint64Map m_dlTxData; //!< Amount of DL TX Data by (IMSI, LCID) pair
  NistUint64Map m_dlRxData; //!< Amount of DL RX Data by (IMSI, LCID) pair
  NistUint64StatsMap m_dlDelay; //!< DL delay by (IMSI, LCID) pair
  NistUint32StatsMap m_dlPduSize; //!< DL PDU Size by (IMSI, LCID) pair

  NistUint32Map m_ulCellId; //!< List of UL CellIds by (IMSI, LCID) pair
  NistUint32Map m_ulTxPackets; //!< Number of UL TX Packets by (IMSI, LCID) pair
  NistUint32Map m_ulRxPackets; //!< Number of UL RX Packets by (IMSI, LCID) pair
  NistUint64Map m_ulTxData; //!< Amount of UL TX Data by (IMSI, LCID) pair
  NistUint64Map m_ulRxData; //!< Amount of UL RX Data by (IMSI, LCID) pair
  NistUint64StatsMap m_ulDelay; //!< UL delay by (IMSI, LCID) pair
  NistUint32StatsMap m_ulPduSize; //!< UL PDU Size by (IMSI, LCID) pair
...
#endif /* NIST_RADIO_BEARER_STATS_CALCULATOR_H_ */
