...
#ifndef NIST_RADIO_ENVIRONMENT_MAP_HELPER_H
#define NIST_RADIO_ENVIRONMENT_MAP_HELPER_H
 ...
 */
class NistRadioEnvironmentMapHelper : public Object
{
public:  

  NistRadioEnvironmentMapHelper ();
  virtual ~NistRadioEnvironmentMapHelper ();
  ...
  /** 
   * Deploy the NistRemSpectrumPhy objects that generate the map according to the specified settings.
   * 
   */
  void Install ();
...
}; // end of `class NistRadioEnvironmentMapHelper`


} // end of `namespace ns3`

#endif /* NIST_RADIO_ENVIRONMENT_MAP_HELPER_H */
