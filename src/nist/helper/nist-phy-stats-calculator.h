...
#ifndef NIST_PHY_STATS_CALCULATOR_H_
#define NIST_PHY_STATS_CALCULATOR_H_
 ...
 */
class NistPhyStatsCalculator : public NistLteStatsCalculator
{
public:
  /**
   * Constructor
   */
  NistPhyStatsCalculator ();

  /**
   * Destructor
   */
  virtual ~NistPhyStatsCalculator ();
   ...
   * \param sinr 
   */
  static void ReportCurrentCellRsrpSinrCallback (Ptr<NistPhyStatsCalculator> phyStats,
   ...
   * \param sinrLinear 
   */
  static void ReportUeSinr (Ptr<NistPhyStatsCalculator> phyStats, std::string path,
   ...
   * \param interference 
   */
  static void ReportInterference (Ptr<NistPhyStatsCalculator> phyStats, std::string path,
...
#endif /* NIST_PHY_STATS_CALCULATOR_H_ */
