 ...
 */
#ifndef NIST_ON_OFF_HELPER_H
#define NIST_ON_OFF_HELPER_H
 ...
 * on a set of nodes.
 */
class NistOnOffHelper
{
public:
  /**
   * Create an NistOnOffHelper to make it easier to work with OnOffApplications
   *
   ...
   *        to.
   */
  NistOnOffHelper (std::string protocol, Address address);
