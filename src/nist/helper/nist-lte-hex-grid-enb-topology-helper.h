...
#ifndef NIST_LTE_HEX_GRID_ENB_TOPOLOGY_HELPER_H
#define NIST_LTE_HEX_GRID_ENB_TOPOLOGY_HELPER_H
 ...
 *
 */
class NistLteHexGridEnbTopologyHelper : public Object
{
public:
  NistLteHexGridEnbTopologyHelper (void);
  virtual ~NistLteHexGridEnbTopologyHelper (void);
   ...
   *
   * \note if no EpcHelper is ever set, then NistLteHexGridEnbTopologyHelper will default
...
#endif // NIST_LTE_HEX_GRID_ENB_TOPOLOGY_HELPER_H
