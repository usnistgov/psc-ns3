...
class Parabolic3dAntennaModelTestCase : public TestCase
{
  public:
    static std::string BuildNameString(Angles a,
                                       ...
                                       double m,
                                       double vg);
    Parabolic3dAntennaModelTestCase(Angles a,
                                    double hb,
                                    double o,
                                    double hg,
                                    double vb,
                                    ...
                                    Parabolic3dAntennaModelGainTestCondition cond);
...
std::string
Parabolic3dAntennaModelTestCase::BuildNameString(Angles a,
                                                 double hb,
                                                 double o,
                                                 double hg,
                                                 double vb,
                                                 ...
                                                 double vg)
{
    ...
    oss << "inclination=" << a.GetInclination() << " , azimuth=" << a.GetAzimuth()
        ...
        << ", orientation=" << o << ", horizontal maxAttenuation=" << hg << " dB"
...
Parabolic3dAntennaModelTestCase::Parabolic3dAntennaModelTestCase(
    Angles a,
    double hb,
    double o,
    double hg,
    ...
    : TestSuite("parabolic-3d-antenna-model", UNIT)
{
    ...
    //                                                                         condition
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(30), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-90), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(100), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(150), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(180), DegreesToRadians(90)),
                                            60,
                                            0,
                                            25,
                                            10,
    ...
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(60), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(160), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(210), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(240), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-40), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-120), DegreesToRadians(90)),
                                            60,
                                            60,
                                            15,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-110), DegreesToRadians(90)),
                                            80,
                                            -150,
                                            10,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-190), DegreesToRadians(90)),
                                            80,
                                            -150,
                                            10,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(-70), DegreesToRadians(90)),
                                            80,
                                            -150,
                                            10,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(92), DegreesToRadians(90)),
                                            80,
                                            -150,
                                            10,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(85)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(95)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(0)),
                                            60,
                                            0,
                                            25,
                                            10,
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(180)),
                                            60,
                                            0,
                                            25,
                                            10,
    ...
    AddTestCase(
        ...
        TestCase::QUICK);
    AddTestCase(
        new Parabolic3dAntennaModelTestCase(Angles(DegreesToRadians(0), DegreesToRadians(100)),
                                            60,
                                            0,
                                            25,
                                            10,
