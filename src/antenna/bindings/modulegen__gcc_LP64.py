...
def register_types(module):
    ...
    ## parabolic-3d-antenna-model.h (module 'antenna'): ns3::Parabolic3dAntennaModel [class]
    module.add_class('Parabolic3dAntennaModel', parent=root_module['ns3::AntennaModel'])
...
def register_methods(root_module):
    ...
    register_Ns3Parabolic3dAntennaModel_methods(root_module, root_module['ns3::Parabolic3dAntennaModel'])
...
def register_Ns3Parabolic3dAntennaModel_methods(root_module, cls):
    ## parabolic-3d-antenna-model.h (module 'antenna'): ns3::Parabolic3dAntennaModel::Parabolic3dAntennaModel() [constructor]
    cls.add_constructor([])
    ## parabolic-3d-antenna-model.h (module 'antenna'): ns3::Parabolic3dAntennaModel::Parabolic3dAntennaModel(ns3::Parabolic3dAntennaModel const & arg0) [constructor]
    cls.add_constructor([param('ns3::Parabolic3dAntennaModel const &', 'arg0')])
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetElectricalTilt() const [member function]
    cls.add_method('GetElectricalTilt', 
                   'double', 
                   [], 
                   is_const=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetGainDb(ns3::Angles a) [member function]
    cls.add_method('GetGainDb', 
                   'double', 
                   [param('ns3::Angles', 'a')], 
                   is_virtual=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetHorizontalBeamwidth() const [member function]
    cls.add_method('GetHorizontalBeamwidth', 
                   'double', 
                   [], 
                   is_const=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetMechanicalTilt() const [member function]
    cls.add_method('GetMechanicalTilt', 
                   'double', 
                   [], 
                   is_const=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetOrientation() const [member function]
    cls.add_method('GetOrientation', 
                   'double', 
                   [], 
                   is_const=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): static ns3::TypeId ns3::Parabolic3dAntennaModel::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): double ns3::Parabolic3dAntennaModel::GetVerticalBeamwidth() const [member function]
    cls.add_method('GetVerticalBeamwidth', 
                   'double', 
                   [], 
                   is_const=True)
    ## parabolic-3d-antenna-model.h (module 'antenna'): void ns3::Parabolic3dAntennaModel::SetElectricalTilt(double electricalTiltDegrees) [member function]
    cls.add_method('SetElectricalTilt', 
                   'void', 
                   [param('double', 'electricalTiltDegrees')])
    ## parabolic-3d-antenna-model.h (module 'antenna'): void ns3::Parabolic3dAntennaModel::SetHorizontalBeamwidth(double horizontalBeamwidthDegrees) [member function]
    cls.add_method('SetHorizontalBeamwidth', 
                   'void', 
                   [param('double', 'horizontalBeamwidthDegrees')])
    ## parabolic-3d-antenna-model.h (module 'antenna'): void ns3::Parabolic3dAntennaModel::SetMechanicalTilt(double mechanicalTiltDegrees) [member function]
    cls.add_method('SetMechanicalTilt', 
                   'void', 
                   [param('double', 'mechanicalTiltDegrees')])
    ## parabolic-3d-antenna-model.h (module 'antenna'): void ns3::Parabolic3dAntennaModel::SetOrientation(double orientationDegrees) [member function]
    cls.add_method('SetOrientation', 
                   'void', 
                   [param('double', 'orientationDegrees')])
    ## parabolic-3d-antenna-model.h (module 'antenna'): void ns3::Parabolic3dAntennaModel::SetVerticalBeamwidth(double verticalBeamwidthDegrees) [member function]
    cls.add_method('SetVerticalBeamwidth', 
                   'void', 
                   [param('double', 'verticalBeamwidthDegrees')])
    return
