 ...
 * and only 1 transmission of each discovery message per period (i.e. no HARQ retransmission of
 * discovery message). Therefore even though there are 6 discovery resources per period, a maximum
 * of 3 applications can be broadcasted by a UE per period. The UEs are close enough that packets
