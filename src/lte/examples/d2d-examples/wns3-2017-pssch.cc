...
main(int argc, char* argv[])
{
    ...
    uint32_t ktrp = 2;        // Transmissions opportunities in a Time Repetition Pattern(number of
    ...
    cmd.AddValue("SlRxOutputFilename",
    ...
    Config::SetDefault("ns3::PhyRxStatsCalculator::SlRxOutputFilename",
                       StringValue(SlRxOutputFilename));
