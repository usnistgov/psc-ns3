...
class LteNistErrorModel
{
  public:
    ...
    /**
     * List of transmission mode. Note that not all transmission modes are available for each
     * physical channel or fading model
     */
    enum LteTxMode
    {
        SISO,
     ...
     */
    static TbErrorStats_t GetPsschBler(LteFadingModel fadingChannel,
                                       LteTxMode txmode,
                                       uint16_t mcs,
                                       double sinr,
     ...
     * \return A Struct of type TbErrorStats_t containing the TB error rate and the SINR
     */
    static TbErrorStats_t GetPsdchBler(LteFadingModel fadingChannel,
                                       LteTxMode txmode,
                                       double sinr,
                                       HarqProcessInfoList_t harqHistory);
     ...
     */
    static double GetPsschSinrFromBler(LteFadingModel fadingChannel,
                                       LteTxMode txmode,
                                       uint16_t mcs,
                                       uint8_t harq,
                                       double bler);
     ...
     * \return A Struct of type TbErrorStats_t containing the TB error rate and the SINR
     */
    static TbErrorStats_t GetPuschBler(LteFadingModel fadingChannel,
                                       LteTxMode txmode,
                                       uint16_t mcs,
                                       double sinr,
                                       HarqProcessInfoList_t harqHistory);
    ...
    // TODO: as error models for other physical channels are added, add new functions. The signature
    // should be the same
  ...
  private:
     ...
     */
    static double GetBlerValue(const double (*xtable)[XTABLE_SIZE],
                               const double* ytable,
     ...
     * \return The SINR value
     */
    static double GetSinrValue(const double (*xtable)[XTABLE_SIZE],
                               const double* ytable,
                               const uint16_t ysize,
                               uint16_t mcs,
                               uint8_t harq,
     ...
     */
    static uint16_t GetBlerIndex(double bler,
                                 uint16_t row,
                                 const double* ytable,
                                 const uint16_t ysize);
     ...
     * \return A Struct of type TbErrorStats_t containing the TB error rate and the SINR
     */
    static TbErrorStats_t GetBler(const double (*xtable)[XTABLE_SIZE],
                                  const double* ytable,
                                  const uint16_t ysize,
                                  uint16_t mcs,
                                  uint8_t harq,
