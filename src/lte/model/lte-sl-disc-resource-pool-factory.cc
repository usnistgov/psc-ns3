...
LteSlDiscResourcePoolFactory::CreatePool()
{
    ...
    {
        m_pool.txParameters.ueSelectedResourceConfig.poolSelection.selection =
    ...
    if (m_rsrpBased && m_rsrpThreshLow <= 7 && m_rsrpThreshHigh <= 7 &&
        m_rsrpThreshLow <= m_rsrpThreshHigh)
    {
        m_pool.txParameters.ueSelectedResourceConfig.poolSelectionRsrpBased.threshLow =
            m_rsrpThreshLow;
        m_pool.txParameters.ueSelectedResourceConfig.poolSelectionRsrpBased.threshHigh =
            m_rsrpThreshHigh;
    }
    else
    {
    ...
    if (m_discTxProb == "p25")
    {
        m_pool.txParameters.ueSelectedResourceConfig.txProbability.probability =
            LteRrcSap::TxProbability::p25;
    }
    else if (m_discTxProb == "p50")
    {
        m_pool.txParameters.ueSelectedResourceConfig.txProbability.probability =
            LteRrcSap::TxProbability::p50;
    }
    else if (m_discTxProb == "p75")
    {
        m_pool.txParameters.ueSelectedResourceConfig.txProbability.probability =
            LteRrcSap::TxProbability::p75;
    }
    else if (m_discTxProb == "p100")
    {
        m_pool.txParameters.ueSelectedResourceConfig.txProbability.probability =
            LteRrcSap::TxProbability::p100;
    }
    else
    {
...
std::string
LteSlDiscResourcePoolFactory::GetDiscCpLen()
{
...
std::string
LteSlDiscResourcePoolFactory::GetDiscPeriod()
{
...
int8_t
LteSlDiscResourcePoolFactory::GetNumRetx()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetNumRepetition()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetDiscPrbNum()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetDiscPrbStart()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetDiscPrbEnd()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetDiscOffset()
{
...
int64_t
LteSlDiscResourcePoolFactory::GetDiscBitmap()
{
...
// Tx Parameters
bool
LteSlDiscResourcePoolFactory::GetHaveTxParameters()
{
...
std::string
LteSlDiscResourcePoolFactory::GetDiscTxAlpha()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetDiscTxP0()
{
...
std::string
LteSlDiscResourcePoolFactory::GetDiscPoolSelection()
{
...
bool
LteSlDiscResourcePoolFactory::GetHaveRsrpBasedPoolSelection()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetRsrpThreshLow()
{
...
int32_t
LteSlDiscResourcePoolFactory::GetRsrpThreshHigh()
{
...
std::string
LteSlDiscResourcePoolFactory::GetDiscTxProbability()
{
