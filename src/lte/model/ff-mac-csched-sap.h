...
class FfMacCschedSapProvider
{
  public:
    ...
    {
        uint32_t
            m_discTxResourceReq; ///< Number of resources the UE requires every discovery period
     ...
     * \param params CschedDiscPoolConfigReqParameters
     */
    virtual void CschedDiscPoolReleaseReq(
        const struct CschedDiscPoolReleaseReqParameters& params){};
...
class MemberCschedSlSapProvider : public FfMacCschedSapProvider
{
  public:
    ...
    void CschedPoolConfigReq(const struct CschedPoolConfigReqParameters& params) override;
    void CschedPoolReleaseReq(const struct CschedPoolReleaseReqParameters& params) override;
    void CschedDiscPoolConfigReq(const struct CschedDiscPoolConfigReqParameters& params) override;
    void CschedDiscPoolReleaseReq(const struct CschedDiscPoolReleaseReqParameters& params) override;
...
template <class C>
MemberCschedSlSapProvider<C>::MemberCschedSlSapProvider(C* scheduler)
    : m_scheduler(scheduler)
{
}
...
template <class C>
void
MemberCschedSlSapProvider<C>::CschedCellConfigReq(
...
template <class C>
void
MemberCschedSlSapProvider<C>::CschedPoolConfigReq(
    const struct CschedPoolConfigReqParameters& params)
{
...
template <class C>
void
MemberCschedSlSapProvider<C>::CschedPoolReleaseReq(
    const struct CschedPoolReleaseReqParameters& params)
{
...
template <class C>
void
MemberCschedSlSapProvider<C>::CschedDiscPoolConfigReq(
    const struct CschedDiscPoolConfigReqParameters& params)
{
...
template <class C>
void
MemberCschedSlSapProvider<C>::CschedDiscPoolReleaseReq(
    const struct CschedDiscPoolReleaseReqParameters& params)
{
