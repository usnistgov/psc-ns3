...
class LteSlDiscResourcePoolFactory : public LteSlPoolFactory
{
  public:
     ...
     */
    std::string GetDiscCpLen();

    /**
     * Get discovery period
     * \return The discovery period
     */
    std::string GetDiscPeriod();
     ...
     */
    std::string GetDiscTxProbability();
