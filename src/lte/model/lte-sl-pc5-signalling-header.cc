...
/*****     LteSlPc5SignallingMessageType : To peek at the first byte of the received message and
 * identify the type       *****/
...
TypeId
LteSlPc5SignallingMessageType::GetTypeId()
{
...
TypeId
LteSlPc5SignallingMessageType::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
LteSlPc5SignallingMessageType::GetSerializedSize() const
{
...
uint8_t
LteSlPc5SignallingMessageType::GetMessageType() const
{
    return m_msgType;
}

std::string
LteSlPc5SignallingMessageType::GetMessageAcronym() const
{
    return s_acronyms[m_msgType];
}

std::string
LteSlPc5SignallingMessageType::GetMessageName() const
{
...
TypeId
DirectCommunicationRequest::GetTypeId()
{
...
TypeId
DirectCommunicationRequest::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
DirectCommunicationRequest::Print(std::ostream& os) const
{
    os << "msgId: " << (uint16_t)m_msgId << " "
       << "seqNum: " << m_seqNum << " userInfoType: " << (uint16_t)m_userInfoType
       << " userInfo: " << m_userInfo << " ";
...
uint32_t
DirectCommunicationRequest::GetSerializedSize() const
{
    uint32_t size = 0;
    size = size + sizeof(m_msgId) + sizeof(m_seqNum) + 1 + sizeof(m_userInfoType) +
           sizeof(m_userInfo) + sizeof(m_ipAddressConfig) + sizeof(m_maxInactivityPeriod) +
           NonceSize + sizeof(m_ueSecurityCapabilities) +
...
void
DirectCommunicationRequest::SetParameters(uint8_t userInfoType,
                                          uint64_t userInfo,
...
uint8_t
DirectCommunicationRequest::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationRequest::GetSequenceNumber() const
{
    return m_seqNum;
}
...
{
    NS_ASSERT_MSG(userInfoType == 3,
                  "Only User Info Type = 3 (IMSI) supported"); // Refer 24.334 Section 12.5.1.3
    m_userInfoType = userInfoType;
    m_userInfo = userInfo;
}

uint64_t
DirectCommunicationRequest::GetUserInfo() const
{
    return m_userInfo;
}

uint8_t
DirectCommunicationRequest::GetUserInfoType() const
{
...
uint64_t
DirectCommunicationRequest::GetImsi() const
{
    return m_userInfo;
}
...
uint8_t
DirectCommunicationRequest::GetIpAddressConfig() const
{
...
uint32_t
DirectCommunicationRequest::GetMaximumInactivityPeriod() const
{
...
uint16_t
DirectCommunicationRequest::GetUeSecurityCapabilities() const
{
...
uint8_t
DirectCommunicationRequest::GetMsbKdId() const
{
    return m_msb;
}
...
uint32_t
DirectCommunicationRequest::GetKdId() const
{
    return m_kdId;
}
...
uint32_t
DirectCommunicationRequest::GetRelayServiceCode() const
{
...
TypeId
DirectCommunicationAccept::GetTypeId()
{
...
TypeId
DirectCommunicationAccept::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationAccept::GetSerializedSize() const
{
    uint32_t size = 0;
...
void
DirectCommunicationAccept::SetParameters(uint8_t ipAddressConfig,
                                         std::vector<uint8_t> linkLocalIpv6Address)
{
    SetIpAddressConfig(ipAddressConfig);
    SetLinkLocalIpv6Address(linkLocalIpv6Address);
...
uint8_t
DirectCommunicationAccept::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationAccept::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint8_t
DirectCommunicationAccept::GetIpAddressConfig() const
{
    return m_ipAddressConfig;
}
...
TypeId
DirectCommunicationReject::GetTypeId()
{
...
TypeId
DirectCommunicationReject::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationReject::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_pc5SignallingCauseValue);
}
...
uint8_t
DirectCommunicationReject::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationReject::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint8_t
DirectCommunicationReject::GetPc5SignallingCauseValue() const
{
...
TypeId
DirectCommunicationKeepalive::GetTypeId()
{
...
TypeId
DirectCommunicationKeepalive::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationKeepalive::GetSerializedSize() const
{
    uint32_t size = 0;
    size = sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_keepaliveCounter);
    if (m_hasMaxInactivityPeriod)
    {
...
uint8_t
DirectCommunicationKeepalive::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationKeepalive::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint32_t
DirectCommunicationKeepalive::GetKeepaliveCounter() const
{
...
uint32_t
DirectCommunicationKeepalive::GetMaximumInactivityPeriod() const
{
    return m_maxInactivityPeriod;
}
...
TypeId
DirectCommunicationKeepaliveAck::GetTypeId()
{
...
TypeId
DirectCommunicationKeepaliveAck::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationKeepaliveAck::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_keepaliveCounter);
}
...
uint8_t
DirectCommunicationKeepaliveAck::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationKeepaliveAck::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint32_t
DirectCommunicationKeepaliveAck::GetKeepaliveCounter() const
{
    return m_keepaliveCounter;
}
...
TypeId
DirectCommunicationRelease::GetTypeId()
{
...
TypeId
DirectCommunicationRelease::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationRelease::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_releaseReason);
}
...
uint8_t
DirectCommunicationRelease::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationRelease::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint8_t
DirectCommunicationRelease::GetReleaseReason() const
{
...
TypeId
DirectCommunicationReleaseAccept::GetTypeId()
{
...
TypeId
DirectCommunicationReleaseAccept::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectCommunicationReleaseAccept::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum);
}
...
uint8_t
DirectCommunicationReleaseAccept::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectCommunicationReleaseAccept::GetSequenceNumber() const
{
    return m_seqNum;
}
...
TypeId
DirectSecurityModeCommand::GetTypeId()
{
...
TypeId
DirectSecurityModeCommand::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
DirectSecurityModeCommand::Print(std::ostream& os) const
{
    ...
    os << "chosenAlgorithmsIntegrity: " << (uint16_t)m_chosenAlgorithmsIntegrity
       << " chosenAlgorithmsCyphering: " << (uint16_t)m_chosenAlgorithmsCyphering
       << " lsb: " << (uint16_t)m_lsb << " ";
...
uint32_t
DirectSecurityModeCommand::GetSerializedSize() const
{
    uint32_t size = 0;
    size = sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_ueSecurityCapabilities) + NonceSize +
           sizeof(m_chosenAlgorithmsIntegrity) + sizeof(m_lsb);
...
DirectSecurityModeCommand::Serialize(Buffer::Iterator start) const
{
    ...
    uint8_t spare = 0;
    uint8_t chosenAlgorithms = (spare << 7) | (m_chosenAlgorithmsCyphering << 5) | (spare << 4) |
                               (m_chosenAlgorithmsIntegrity);
...
DirectSecurityModeCommand::Deserialize(Buffer::Iterator start)
{
    ...
    uint8_t opt_vars_iei = 0;
    uint8_t gpiLength;
    uint8_t encryptedPayloadLength;
    while (!i.IsEnd())
    {
        opt_vars_iei = i.ReadU8();
        switch (opt_vars_iei)
...
void
DirectSecurityModeCommand::SetParameters(uint16_t ueSecurityCapabilities,
...
uint8_t
DirectSecurityModeCommand::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectSecurityModeCommand::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint16_t
DirectSecurityModeCommand::GetUeSecurityCapabilities() const
{
    return m_ueSecurityCapabilities;
}
...
uint8_t
DirectSecurityModeCommand::GetChosenAlgorithmsIntegrity() const
{
    return m_chosenAlgorithmsIntegrity;
}

uint8_t
DirectSecurityModeCommand::GetChosenAlgorithmsCyphering() const
{
    return m_chosenAlgorithmsCyphering;
}

void
DirectSecurityModeCommand::SetChosenAlgorithms(uint8_t chosenAlgorithmsIntegrity,
                                               uint8_t chosenAlgorithmCyphering)
{
...
uint8_t
DirectSecurityModeCommand::GetLsb() const
{
    return m_lsb;
}
...
uint16_t
DirectSecurityModeCommand::GetMsb() const
{
    return m_msb;
}
...
uint64_t
DirectSecurityModeCommand::GetUserInfo() const
{
    return m_userInfo;
}

uint8_t
DirectSecurityModeCommand::GetUserInfoType() const
{
    return m_userInfoType;
}
...
TypeId
DirectSecurityModeComplete::GetTypeId()
{
...
TypeId
DirectSecurityModeComplete::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectSecurityModeComplete::GetSerializedSize() const
{
    uint32_t size = 0;
...
uint8_t
DirectSecurityModeComplete::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectSecurityModeComplete::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint16_t
DirectSecurityModeComplete::GetLsb() const
{
    return m_lsb;
}
...
TypeId
DirectSecurityModeReject::GetTypeId()
{
...
TypeId
DirectSecurityModeReject::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectSecurityModeReject::GetSerializedSize() const
{
    uint32_t size = 0;
    size = size + sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_pc5SignallingCauseValue);
...
uint8_t
DirectSecurityModeReject::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectSecurityModeReject::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint8_t
DirectSecurityModeReject::GetPc5SignallingCauseValue() const
{
    return m_pc5SignallingCauseValue;
}
...
TypeId
DirectRekeyingRequest::GetTypeId()
{
...
TypeId
DirectRekeyingRequest::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectRekeyingRequest::GetSerializedSize() const
{
    uint32_t size = 0;

    size = size + sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_ueSecurityCapabilities) +
           NonceSize + sizeof(m_msb);
...
void
DirectRekeyingRequest::SetParameters(uint16_t ueSecurityCapabilities,
                                     std::vector<uint8_t> nonce1,
                                     uint8_t msb,
                                     uint8_t authFlag,
...
uint8_t
DirectRekeyingRequest::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectRekeyingRequest::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint16_t
DirectRekeyingRequest::GetUeSecurityCapabilities() const
{
    return m_ueSecurityCapabilities;
}
...
uint8_t
DirectRekeyingRequest::GetMsb() const
{
    return m_msb;
}
...
uint8_t
DirectRekeyingRequest::GetAuthFlag() const
{
    return m_authFlag;
}
...
TypeId
DirectRekeyingResponse::GetTypeId()
{
...
TypeId
DirectRekeyingResponse::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectRekeyingResponse::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum);
}
...
uint8_t
DirectRekeyingResponse::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectRekeyingResponse::GetSequenceNumber() const
{
    return m_seqNum;
}
...
TypeId
DirectRekeyingTrigger::GetTypeId()
{
...
TypeId
DirectRekeyingTrigger::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
DirectRekeyingTrigger::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum);
}
...
uint8_t
DirectRekeyingTrigger::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
DirectRekeyingTrigger::GetSequenceNumber() const
{
    return m_seqNum;
}
...
TypeId
RemoteUeInfoRequest::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
RemoteUeInfoRequest::GetSerializedSize() const
{
    return sizeof(m_msgId) + sizeof(m_seqNum) + sizeof(m_remoteUeInfoType);
}
...
uint8_t
RemoteUeInfoRequest::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
RemoteUeInfoRequest::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint8_t
RemoteUeInfoRequest::GetRemoteUeInfoType() const
{
...
TypeId
RemoteUeInfoResponse::GetTypeId()
{
...
TypeId
RemoteUeInfoResponse::GetInstanceTypeId() const
{
    return GetTypeId();
}
...
uint32_t
RemoteUeInfoResponse::GetSerializedSize() const
{
    uint32_t size = 0;
    size = size + sizeof(m_msgId) + sizeof(m_seqNum);
...
uint8_t
RemoteUeInfoResponse::GetMessageIdentifier() const
{
    return m_msgId;
}

uint16_t
RemoteUeInfoResponse::GetSequenceNumber() const
{
    return m_seqNum;
}
...
uint64_t
RemoteUeInfoResponse::GetImei() const
{
    return m_imei;
}
