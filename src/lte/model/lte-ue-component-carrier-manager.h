...
class LteUeComponentCarrierManager : public Object
{
  ...
  protected:
     ...
     */
    std::map<uint8_t, std::map<UeCcmSidelinkLcIdentifier, LteMacSapProvider*>>
        m_slComponentCarrierLcMap;
    std::map<UeCcmSidelinkLcIdentifier, UeCcmLcInfo>
        m_slLcInfoMap; ///< Sidelink logical channel info map
