...
LteSlPreconfigPoolFactory::CreatePool ()
{
  ...
  //pool.dataHoppingConfig.numSubbands = LteRrcSap::SlHoppingConfigComm::ns4;
  ...
  if (m_txAlpha == "al0") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al0;}
  else if (m_txAlpha == "al04") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al04;}
  else if (m_txAlpha == "al05") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al05;}
  else if (m_txAlpha == "al06") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al06;}
  else if (m_txAlpha == "al07") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al07;}
  else if (m_txAlpha == "al08") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al08;}
  else if (m_txAlpha == "al09") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al09;}
  else if (m_txAlpha == "al1") {m_pool.scTxParameters.alpha = LteRrcSap::SlTxParameters::al1;}
