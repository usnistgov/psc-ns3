...
class RrSlFfMacScheduler : public FfMacScheduler
{
  ...
  private:
     ...
     */
    void DoCschedDiscPoolConfigReq(
     ...
     */
    void DoCschedDiscPoolReleaseReq(
    ...
    struct PoolInfo
    {
        ...
        std::map<uint16_t, PoolUserAllocation>
            m_currentAllocation; ///< map the RNTI and current allocation
        std::map<uint16_t, PoolUserAllocation>
            m_nextAllocation; ///< map the RNTI and next allocation
