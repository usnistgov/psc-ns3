...
LteSlResourcePoolFactory::CreatePool()
{
    ...
    if (m_ueSelected)
    {
        ...
        m_pool.ueSelectedResourceConfig.dataTfResourceConfig.subframeBitmap.bitmap =
            std::bitset<40>(m_dataBitmapValue);
    }
...
std::string
LteSlResourcePoolFactory::GetControlCpLen()
{
    NS_LOG_FUNCTION(this);
    return m_scCpLen;
}
...
std::string
LteSlResourcePoolFactory::GetControlPeriod()
{
    NS_LOG_FUNCTION(this);
    return m_period;
}
...
int8_t
LteSlResourcePoolFactory::GetControlPrbNum()
{
    NS_LOG_FUNCTION(this);
    return m_scPrbNum;
}
...
int8_t
LteSlResourcePoolFactory::GetControlPrbStart()
{
    NS_LOG_FUNCTION(this);
    return m_scPrbStart;
}
...
int8_t
LteSlResourcePoolFactory::GetControlPrbEnd()
{
    NS_LOG_FUNCTION(this);
    return m_scPrbEnd;
}
...
int16_t
LteSlResourcePoolFactory::GetControlOffset()
{
    NS_LOG_FUNCTION(this);
    return m_scOffset;
}
...
int64_t
LteSlResourcePoolFactory::GetControlBitmap()
{
    NS_LOG_FUNCTION(this);
...
// Data
std::string
LteSlResourcePoolFactory::GetDataCpLen()
{
    NS_LOG_FUNCTION(this);
    return m_dataCpLen;
}
...
uint16_t
LteSlResourcePoolFactory::GetDataHoppingParameter()
{
    NS_LOG_FUNCTION(this);
...
std::string
LteSlResourcePoolFactory::GetDataHoppingSubbands()
{
    NS_LOG_FUNCTION(this);
    return m_subbands;
}
...
int8_t
LteSlResourcePoolFactory::GetDataHoppingOffset()
{
    NS_LOG_FUNCTION(this);
    return m_rbOffset;
}
...
int8_t
LteSlResourcePoolFactory::GetDataHoppingInfo()
{
    NS_LOG_FUNCTION(this);
...
// UE Selected Parameters
bool
LteSlResourcePoolFactory::GetHaveUeSelectedResourceConfig()
{
    NS_LOG_FUNCTION(this);
    return m_ueSelected;
}
...
bool
LteSlResourcePoolFactory::GetHaveTrptSubset()
{
    NS_LOG_FUNCTION(this);
...
int64_t
LteSlResourcePoolFactory::GetTrptSubset()
{
    NS_LOG_FUNCTION(this);
...
int8_t
LteSlResourcePoolFactory::GetDataPrbNum()
{
    NS_LOG_FUNCTION(this);
    return m_dataPrbNum;
}
...
int8_t
LteSlResourcePoolFactory::GetDataPrbStart()
{
    NS_LOG_FUNCTION(this);
...
int8_t
LteSlResourcePoolFactory::GetDataPrbEnd()
{
    NS_LOG_FUNCTION(this);
    return m_dataPrbEnd;
}
...
int16_t
LteSlResourcePoolFactory::GetDataOffset()
{
    NS_LOG_FUNCTION(this);
    return m_dataOffset;
}
...
int64_t
LteSlResourcePoolFactory::GetDataBitmap()
{
    NS_LOG_FUNCTION(this);
...
// Tx Parameters
bool
LteSlResourcePoolFactory::GetHaveTxParameters()
{
    NS_LOG_FUNCTION(this);
    return m_txParam;
}
...
std::string
LteSlResourcePoolFactory::GetControlTxAlpha()
{
    NS_LOG_FUNCTION(this);
    return m_txAlpha;
}
...
int16_t
LteSlResourcePoolFactory::GetControlTxP0()
{
    NS_LOG_FUNCTION(this);
    return m_txP0;
}
...
std::string
LteSlResourcePoolFactory::GetDataTxAlpha()
{
    NS_LOG_FUNCTION(this);
    return m_dataAlpha;
}
