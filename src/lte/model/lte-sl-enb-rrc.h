...
class LteSlEnbRrc : public Object
{
  ...
  private:
     ...
     */
    bool IsPoolInList(LteRrcSap::SlCommResourcePool pool,
     ...
     */
    bool IsPoolInList(LteRrcSap::SlDiscResourcePool pool,
                      LteRrcSap::SlDiscResourcePool* pools,
                      int nbPool);

    // Add information about pools allocated for communication and discovery
    std::map<uint32_t, LteRrcSap::SlCommTxResourcesSetup>
        m_preconfigDedicatedPoolMap; ///< Pre-provisioned dedicated pools using the group L2 address
    // discovery pools
    ...
    LteRrcSap::SlCommTxPoolList
        m_preconfigCommTxPoolExceptional; ///< Pre-provisioned pool for exceptional cases
    LteRrcSap::SystemInformationBlockType18
        m_sib18; ///< System Information Block Type 18 currently broadcasted
    LteRrcSap::SystemInformationBlockType19
        m_sib19;        ///< System Information Block Type 19 currently broadcasted
