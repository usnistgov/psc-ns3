...
class LteSlO2oCommParams : public Object
{
  public:
    ...
    struct LteSlPc5ContextId
    {
        ...
        {
            return lhs.peerL2Id < rhs.peerL2Id ||
                   (lhs.peerL2Id == rhs.peerL2Id && lhs.contextId < rhs.contextId);
        }
    };
  ...
  public:
     ...
     */
    uint16_t GetRelayRuirCount() const;
    /**
     *
     ...
     */
    uint16_t GetRemoteDcrCount() const;
    /**
     *
     ...
     */
    uint16_t GetRemoteDcrqCount() const;
    /**
     *
     ...
     */
    uint16_t GetRemoteDckCount() const;
    /**
     *
     ...
     */
    uint16_t GetRemoteKaCount() const;
    /**
     *
     ...
     */
    DirectCommunicationRequest GetDcrqRetrans() const;
    /**
     *
     ...
     */
    DirectCommunicationRelease GetDcrRetrans() const;
     ...
     */
    DirectCommunicationKeepalive GetDckRetrans() const;
    /**
     *
     ...
     */
    RemoteUeInfoRequest GetRuirqRetrans() const;
    /**
     *
     ...
     */
    DirectSecurityModeCommand GetDsmcmRetrans() const;
    /**
     *
    ...
    /**
     *
     * \return security_mode_state the flag to identify if the direct security mode control state of
     * this context
     */
    DirectSecurityModeState GetSecurityModeState() const;
    /**
     *
     * \param value the flag value to be set to identify if the direct security mode control state
     * of this context
     */
     ...
     */
    uint8_t GetSecurityModeId() const;
