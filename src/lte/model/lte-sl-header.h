...
class LteSlDiscHeader : public Header
{
  public:
     ...
     */
    uint8_t BuildDiscoveryMsgType() const;
     ...
     */
    void SetRelayAnnouncementParameters(uint32_t serviceCode,
     ...
     * \param relayUeId the layer 2 ID of the relay node
     */
    void SetRelaySoliciationParameters(uint32_t serviceCode,
     ...
     * \param status the status code
     */
    void SetRelayResponseParameters(uint32_t serviceCode,
  ...
  private:
    ...
    uint32_t
        m_appCode; ///< ProSe Application Code (32 bits instead of 184 bits defined in standard)
...
class LteSlSciHeader : public Header
{
  public:
     ...
     */
    void SetSciFormat0Params(bool hopping,
                             uint8_t rbStart,
                             uint8_t rbLen,
                             uint8_t hoppingInfo,
                             uint8_t trp,
