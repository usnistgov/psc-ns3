...
class LteSlUeCtrlSapProvider
{
  public:
     ...
     */
    virtual void RecvRelayServiceDiscovery(uint32_t serviceCode,
     ...
     */
    virtual void Pc5ConnectionStarted(uint32_t peerUeId,
                                      uint32_t selfUeId,
                                      LteSlUeRrc::RelayRole role) = 0;
     ...
     * \param role The role of this node (remote or relay)
     */
    virtual void Pc5SecuredEstablished(uint32_t peerUeId,
                                       uint32_t selfUeId,
                                       LteSlUeRrc::RelayRole role) = 0;
     ...
     * \param role The role of this node (remote or relay)
     */
    virtual void Pc5ConnectionTerminated(uint32_t peerUeId,
                                         uint32_t selfUeId,
                                         LteSlUeRrc::RelayRole role) = 0;
     ...
     */
    virtual void Pc5ConnectionAborted(uint32_t peerUeId,
                                      uint32_t selfUeId,
                                      LteSlUeRrc::RelayRole role,
                                      LteSlO2oCommParams::UeO2ORejectReason reason) = 0;
     ...
     *
     * \param validRelays the list of valid Relay UEs detected in the proximity offering the service
     * code \param serviceCode the relay service code \param currentRelayId the Id of the Relay UE
     * to which the UE is currently connected for the service code (Zero if none)
     *
     * \return selectedRelayId the Id of the selected Realy UE
     */
    virtual uint64_t RelayUeSelection(std::map<uint64_t, double> validRelays,
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::RecvRelayServiceDiscovery(uint32_t serviceCode,
                                                           uint64_t announcerInfo,
                                                           uint32_t proseRelayUeId,
                                                           uint8_t statusIndicator)
{
    return m_owner->DoRecvRelayServiceDiscovery(serviceCode,
                                                announcerInfo,
                                                proseRelayUeId,
                                                statusIndicator);
}
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::Pc5ConnectionStarted(uint32_t remoteUeId,
                                                      uint32_t selfUeId,
                                                      LteSlUeRrc::RelayRole role)
{
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::Pc5SecuredEstablished(uint32_t remoteUeId,
                                                       uint32_t selfUeId,
                                                       LteSlUeRrc::RelayRole role)
{
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::Pc5ConnectionTerminated(uint32_t remoteUeId,
                                                         uint32_t selfUeId,
                                                         LteSlUeRrc::RelayRole role)
{
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::Pc5ConnectionAborted(uint32_t peerUeId,
                                                      uint32_t selfUeId,
                                                      LteSlUeRrc::RelayRole role,
...
template <class C>
void
MemberLteSlUeCtrlSapProvider<C>::RecvRemoteUeReport(uint64_t localImsi,
                                                    uint32_t peerUeId,
                                                    uint64_t remoteImsi)
{
...
template <class C>
uint64_t
MemberLteSlUeCtrlSapProvider<C>::RelayUeSelection(std::map<uint64_t, double> validRelays,
                                                  uint32_t serviceCode,
...
class MemberLteSlUeCtrlSapUser : public LteSlUeCtrlSapUser
{
  ...
  private:
    MemberLteSlUeCtrlSapUser() = delete;
    C* m_owner; ///< the owner class
