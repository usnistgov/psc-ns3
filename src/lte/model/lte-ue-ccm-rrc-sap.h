...
class LteUeCcmRrcSapProvider
{
  ...
  public:
     ...
     * \param slLcConfig is a single structure contains logical Channel Id, Logical Channel config
     * and Component Carrier Id \param msu is the pointer to LteMacSapUser related to the Rlc
     * instance \return vector of LcsConfig contains the lc configuration for each Mac the size of
     * the vector is equal to the number of component carrier enabled.
     *
     * The Logical Channel configurations for each component carrier depend on the
     * algorithm used to split the traffic between the component carriers themself.
     */
    virtual std::vector<LteUeCcmRrcSapProvider::LcsConfig> AddSlLc(
        uint8_t slLcId,
        uint32_t srcL2Id,
        uint32_t dstL2Id,
        LteUeCmacSapProvider::LogicalChannelConfig slLcConfig,
        LteMacSapUser* msu) = 0;
...
class MemberLteUeCcmRrcSapProvider : public LteUeCcmRrcSapProvider
{
  public:
    ...
    std::vector<LteUeCcmRrcSapProvider::LcsConfig> AddSlLc(
        uint8_t slLcId,
        uint32_t srcL2Id,
        uint32_t dstL2Id,
        LteUeCmacSapProvider::LogicalChannelConfig slLcConfig,
...
template <class C>
std::vector<LteUeCcmRrcSapProvider::LcsConfig>
MemberLteUeCcmRrcSapProvider<C>::AddSlLc(uint8_t slLcId,
                                         uint32_t srcL2Id,
                                         uint32_t dstL2Id,
                                         LteUeCmacSapProvider::LogicalChannelConfig slLcConfig,
                                         LteMacSapUser* msu)
