...
static const uint8_t ItrpToKtrpMap[107] = {
    ...
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 8};
...
static const std::bitset<8> ItrpToBitmap[107] = {
    std::bitset<8>(std::string("10000000")), std::bitset<8>(std::string("01000000")),
    std::bitset<8>(std::string("00100000")), std::bitset<8>(std::string("00010000")),
    std::bitset<8>(std::string("00001000")), std::bitset<8>(std::string("00000100")),
    std::bitset<8>(std::string("00000010")), std::bitset<8>(std::string("00000001")),
    std::bitset<8>(std::string("11000000")), // k=2
    std::bitset<8>(std::string("10100000")),
    std::bitset<8>(std::string("01100000")), // 10
    std::bitset<8>(std::string("10010000")), std::bitset<8>(std::string("01010000")),
    std::bitset<8>(std::string("00110000")), std::bitset<8>(std::string("10001000")),
    std::bitset<8>(std::string("01001000")), std::bitset<8>(std::string("00101000")),
    std::bitset<8>(std::string("00011000")), std::bitset<8>(std::string("10000100")),
    std::bitset<8>(std::string("01000100")),
    std::bitset<8>(std::string("00100100")), // 20
    std::bitset<8>(std::string("00010100")), std::bitset<8>(std::string("00001100")),
    std::bitset<8>(std::string("10000010")), std::bitset<8>(std::string("01000010")),
    std::bitset<8>(std::string("00100010")), std::bitset<8>(std::string("00010010")),
    std::bitset<8>(std::string("00001010")), std::bitset<8>(std::string("00000110")),
    std::bitset<8>(std::string("10000001")),
    std::bitset<8>(std::string("01000001")), // 30
    std::bitset<8>(std::string("00100001")), std::bitset<8>(std::string("00010001")),
    std::bitset<8>(std::string("00001001")), std::bitset<8>(std::string("00000101")),
    std::bitset<8>(std::string("00000011")), std::bitset<8>(std::string("11110000")),
    std::bitset<8>(std::string("11101000")), std::bitset<8>(std::string("11011000")),
    std::bitset<8>(std::string("10111000")),
    std::bitset<8>(std::string("01111000")), // 40
    std::bitset<8>(std::string("11100100")), std::bitset<8>(std::string("11010100")),
    std::bitset<8>(std::string("10110100")), std::bitset<8>(std::string("01110100")),
    std::bitset<8>(std::string("11001100")), std::bitset<8>(std::string("10101100")),
    std::bitset<8>(std::string("01101100")), std::bitset<8>(std::string("10011100")),
    std::bitset<8>(std::string("01011100")),
    std::bitset<8>(std::string("00111100")), // 50
    std::bitset<8>(std::string("11100010")), std::bitset<8>(std::string("11010010")),
    std::bitset<8>(std::string("10110010")), std::bitset<8>(std::string("01110010")),
    std::bitset<8>(std::string("11001010")), std::bitset<8>(std::string("10101010")),
    std::bitset<8>(std::string("01101010")), std::bitset<8>(std::string("10011010")),
    std::bitset<8>(std::string("01011010")),
    std::bitset<8>(std::string("00111010")), // 60
    std::bitset<8>(std::string("11000110")), std::bitset<8>(std::string("11000110")),
    std::bitset<8>(std::string("01100110")), std::bitset<8>(std::string("10010110")),
    std::bitset<8>(std::string("01010110")), std::bitset<8>(std::string("00110110")),
    std::bitset<8>(std::string("10001110")), std::bitset<8>(std::string("01001110")),
    std::bitset<8>(std::string("00101110")),
    std::bitset<8>(std::string("00011110")), // 70
    std::bitset<8>(std::string("11100001")), std::bitset<8>(std::string("11010001")),
    std::bitset<8>(std::string("10110001")), std::bitset<8>(std::string("01110001")),
    std::bitset<8>(std::string("11001001")), std::bitset<8>(std::string("10101001")),
    std::bitset<8>(std::string("01101001")), std::bitset<8>(std::string("10011001")),
    std::bitset<8>(std::string("01011001")),
    std::bitset<8>(std::string("00111001")), // 80
    std::bitset<8>(std::string("11000101")), std::bitset<8>(std::string("10100101")),
    std::bitset<8>(std::string("01100101")), std::bitset<8>(std::string("10010101")),
    std::bitset<8>(std::string("01010101")), std::bitset<8>(std::string("00110101")),
    std::bitset<8>(std::string("10001101")), std::bitset<8>(std::string("01001101")),
    std::bitset<8>(std::string("00101101")),
    std::bitset<8>(std::string("00011101")), // 90
    std::bitset<8>(std::string("11000011")), std::bitset<8>(std::string("10100011")),
    std::bitset<8>(std::string("01100011")), std::bitset<8>(std::string("10010011")),
    std::bitset<8>(std::string("01010011")), std::bitset<8>(std::string("00110011")),
    std::bitset<8>(std::string("10001011")), std::bitset<8>(std::string("01001011")),
    std::bitset<8>(std::string("00101011")),
    std::bitset<8>(std::string("00011011")), // 100
    std::bitset<8>(std::string("10000111")), std::bitset<8>(std::string("01000111")),
    std::bitset<8>(std::string("00100111")), std::bitset<8>(std::string("00010111")),
    std::bitset<8>(std::string("00001111")), std::bitset<8>(std::string("11111111"))};

NS_LOG_COMPONENT_DEFINE("LteSlPool");
NS_OBJECT_ENSURE_REGISTERED(SidelinkCommResourcePool);

///// SidelinkCommResourcePool //////
SidelinkCommResourcePool::SidelinkCommResourcePool()
    : m_type(SidelinkCommResourcePool::UNKNOWN)
{
...
TypeId
SidelinkCommResourcePool::GetTypeId()
{
    static TypeId tid =
...
bool
SidelinkCommResourcePool::operator==(const SidelinkCommResourcePool& other)
{
    bool equal = m_type == other.m_type && m_scCpLen.cplen == other.m_scCpLen.cplen &&
...
SidelinkCommResourcePool::GetCurrentScPeriod(uint32_t frameNo, uint32_t subframeNo)
{
    ...
    int32_t currentPeriod =
        std::floor((subframe - m_scTfResourceConfig.offsetIndicator.offset) / (double)period);
    ...
    NS_LOG_DEBUG("Current frame = " << currentScPeriod.frameNo << "Current subframe = "
                                    << currentScPeriod.subframeNo << ", period (ms) = " << period
...
SidelinkCommResourcePool::GetNextScPeriod(uint32_t frameNo, uint32_t subframeNo)
{
    ...
    uint32_t nextStart =
        (m_scTfResourceConfig.offsetIndicator.offset + (currentPeriod + 1) * period);
    nextScPeriod.frameNo = (nextStart / 10) % 1024;
    nextScPeriod.subframeNo = nextStart % 10;

    NS_LOG_DEBUG("subframe = " << subframe << ", period (ms) = " << period << ", currentPeriod = "
                               << currentPeriod << ", nextStart = " << nextStart);
    NS_LOG_DEBUG("Next Frame No = " << nextScPeriod.frameNo
                                    << ", Next subframe No = " << nextScPeriod.subframeNo);
    m_nextScPeriod(nextScPeriod.frameNo,
                   nextScPeriod.subframeNo,
                   nextStart); // ReportNextScPeriod trace
    return nextScPeriod;
}
...
SidelinkCommResourcePool::GetPscchTransmissions(uint32_t n)
{
    ...
    NS_ASSERT_MSG(n < m_nPscchResources,
                  "Requesting resource " << n << " but max is " << m_nPscchResources);
...
SidelinkCommResourcePool::GetPscchOpportunities(uint32_t frameNo, uint32_t subframeNo)
{
    ...
    int32_t currentPeriod =
        std::floor((subframe - m_scTfResourceConfig.offsetIndicator.offset) / (double)period);
    NS_LOG_DEBUG("Subframe " << subframe << ", offset"
                             << m_scTfResourceConfig.offsetIndicator.offset << ", current period"
                             << currentPeriod);
    uint32_t currentStart = m_scTfResourceConfig.offsetIndicator.offset + currentPeriod * period;
...
std::list<SidelinkCommResourcePool::SidelinkTransmissionInfo>
SidelinkCommResourcePool::GetPsschTransmissions(SidelinkCommResourcePool::SubframeInfo periodStart,
                                                uint8_t itrp,
                                                uint8_t rbStart,
                                                uint8_t rbLen)
{
    NS_LOG_FUNCTION(this << Simulator::Now().GetMilliSeconds() << "Frame no. "
                         << periodStart.frameNo << "subframe no. " << periodStart.subframeNo
                         << "itrp  " << (uint16_t)itrp << " rbStart " << (uint16_t)rbStart
                         << " rbLen " << (uint16_t)rbLen);
    ...
    if (m_type == SidelinkCommResourcePool::UE_SELECTED)
    {
        ...
        NS_ASSERT((ktrp == 1 && m_trptSubset.subset[0]) || (ktrp == 2 && m_trptSubset.subset[1]) ||
                  (ktrp == 4 && m_trptSubset.subset[2]) || ktrp == 8 /*m_preconfigured*/);
        ...
        for (uint8_t i = rbStart; i < rbStart + rbLen; i++)
        {
            NS_ASSERT_MSG(i < m_dataTfResourceConfig.prbStart + m_dataTfResourceConfig.prbNum ||
                          ...
                          "Rb = " << (uint16_t)i << " not within range: prbStart = "
                                  << (uint16_t)m_dataTfResourceConfig.prbStart
                                  << ", prbStop = " << (uint16_t)m_dataTfResourceConfig.prbEnd
                                  << ", prbNum = " << (uint16_t)m_dataTfResourceConfig.prbNum);
        }
    }
    ...
    for (uint32_t i = 0; i < m_lpssch; i++)
    {
        ...
        if (bitmap[7 - (i % ntrp)] &&
            periodSubframe + m_lpsschVector[i] <
                10240) // reverse order because b0 is the msb in the bitmap
        {
    ...
    std::vector<std::vector<uint32_t>>
        nPrbVector; // Type 2 frequency hopping PRBs starting indexes per transmission

    if (m_dataHoppingConfig.hoppingInfo <= 3) // If frequency hopping enabled
    {
        uint8_t rbOffset =
            m_dataHoppingConfig.rbOffset; // resource block offset used for frequency hopping
        ...
        else // Type 2 frequency hopping
        {
            ...
            NS_ASSERT_MSG(nPrbVector.size() == psschsubframes.size(),
                          "SOMETHING WENT WRONG WHILE COMPUTING PRB INDEXES FOR FREQUENCY HOPPING "
                          "TYPE 2, nPrbVector SIZE MISMATCH!");
        }
    }
    ...
    for (auto it = psschsubframes.begin(); it != psschsubframes.end(); it++)
    {
        ...
        {
            NS_LOG_INFO("SF: " << *it << ", info.rbStart = nPRB = nPrbVector[" << tx_counter - 1
                               << "][0]: " << nPrbVector[tx_counter - 1][0]);
            info.rbStart =
                (uint8_t)nPrbVector[tx_counter - 1]
                                   [0]; // set the slot or subframe to the according nPRB value
        }
...
SidelinkCommResourcePool::GetTbPerSlPeriod()
{
    ...
    for (uint32_t i = 0; i < m_trptSubset.subset.size(); i++)
    {
        ...
        {
            tbPerKtrpVector[i] =
                (uint32_t)std::pow(2, double(i)) * m_lpssch / 32; // Ntrp=8;HARQ=4;Ntrp*HARQ = 32
        }
    }
    if (m_trptSubset.subset.size() == 3 && m_trptSubset.subset.to_ulong() == 0)
    {
        tbPerKtrpVector[3] =
            (uint32_t)std::pow(2, double(3)) * m_lpssch / 32; //  Ntrp=8;HARQ=4;Ntrp*HARQ = 32
    }
...
SidelinkCommResourcePool::GetValidRBstart(uint8_t rbLen)
{
    ...
    if (m_dataHoppingConfig.hoppingInfo <= 3) // Frequency Hopping Enabled
    {
        ...
        // used to check that the rbLen is valid (if given rbLen from GetValidAllocations() it will
        // always be a valid value
        ...
        if (m_dataHoppingConfig.hoppingInfo <= 2) // Type 1 Frequency Hopping Enabled
        {
            ...
            NS_LOG_LOGIC("Type 1, hoppingInfo: " << (uint16_t)m_dataHoppingConfig.hoppingInfo
                                                 << ", m_rbpssch: " << m_rbpssch
                                                 << ", maxLcrbs: " << (uint16_t)maxLcrbs);

            // check if the rbLen is invalid
            if (rbLen > maxLcrbs)
            {
                NS_FATAL_ERROR(this << "INVALID rbLen " << uint16_t(rbLen)
                                    << " must be <= " << uint16_t(maxLcrbs));
            }
            ...
            for (uint8_t i = m_dataTfResourceConfig.prbStart; i <= m_dataTfResourceConfig.prbEnd;
                 ++i)
            {
                // check if the rbStart and contiguous resource blocks are within the valid resource
                // pool
                if (IsInPool(i, 1))
                {
                    nSL0 = i + (rbOffset / 2);
        ...
        else if (m_dataHoppingConfig.hoppingInfo == 3) // Type 2 Frequency Hopping Enabled
        {
            ...
            maxLcrbs = uint8_t(std::min(std::floor(std::pow(2, double(y)) / m_rbpssch),
                                        std::floor(nRbpssch / m_dataHoppingConfig.numSubbands)));
            NS_LOG_LOGIC("Type 2, hoppingInfo: "
                         << (uint16_t)m_dataHoppingConfig.hoppingInfo
                         << ", nRbpssch: " << (uint16_t)nRbpssch << ", numSubbands: "
                         << m_dataHoppingConfig.numSubbands << ", sbSize: " << (uint16_t)sbSize
                         << ", maxLcrbs: " << (uint16_t)maxLcrbs);
            ...
            uint8_t totalAllocationsPerSb =
                sbSize - rbLen + 1;  // Number of possible allocations in a sub-band
            ...
            uint8_t effectiveOffset =
                m_rbpssch -
                nRbpssch; // avoid comparing numSubbands to figure out if an offset was used
            NS_LOG_LOGIC("rbStartIndexes:");
            for (uint8_t i = m_dataTfResourceConfig.prbStart; i <= m_dataTfResourceConfig.prbEnd;
                 ++i)
            { // check if the resource block is within the valid resource pool
                ...
                { // New sub-band
                    ...
                    {
                        // check if the contiguous resource blocks are within the valid resource
                        // pool
...
SidelinkCommResourcePool::GetValidAllocations()
{
    ...
    if (m_dataHoppingConfig.hoppingInfo <= 3) // Frequency Hopping Enabled
    {
        ...
        {
            NS_FATAL_ERROR(
                this << " GetValidAllocations() TYPE 2 FREQUENCY HOPPING IS NOT IMPLEMENTED.");
        ...
        else
        {
            ...
            NS_FATAL_ERROR(
                this << " GetValidAllocations() CANNOT BE CALLED WITH FREUQNECY HOPPING DISABLED.");
        }
    }
...
SidelinkCommResourcePool::TranslatePscch(SidelinkCommResourcePool::SidelinkTransmissionInfo info)
{
    ...
    NS_LOG_DEBUG("Mapped frame/subframe number "
                 << info.subframe.frameNo << "/" << info.subframe.subframeNo
                 << " to frame/subframe number " << translatedInfo.subframe.frameNo << "/"
                 << translatedInfo.subframe.subframeNo);
...
SidelinkCommResourcePool::IsInPool(uint8_t rbStart, uint8_t rbLen, uint8_t rbOffset)
{
    ...
    for (uint8_t i = rbStart; i < rbStart + rbLen; ++i)
    {
        ...
        if (((i >= m_dataTfResourceConfig.prbStart + m_dataTfResourceConfig.prbNum &&
              i <= m_dataTfResourceConfig.prbEnd - m_dataTfResourceConfig.prbNum) ||
             i < m_dataTfResourceConfig.prbStart + (rbOffset / 2) ||
             i > m_dataTfResourceConfig.prbEnd - (rbOffset / 2)))
        {
            return false;
        }
    }
...
SidelinkCommResourcePool::GetNprbType1(uint8_t rbStart)
{
    ...
    if (m_dataHoppingConfig.hoppingInfo <= 2) // Type 1 Frequency Hopping Enabled
    {
        ...
        case 0:
            ...
            break;
        case 1: {
            // Modulo operation does not compute the desired result for negative dividends, hence we
        ...
        default:
            NS_FATAL_ERROR(
                this << " INVALID HOPPINGINFO VALUE FOR TYPE 1 FREQUENCY HOPPING."); // should never
                                                                                     // occur
        }
    }
    else
    ...
    NS_LOG_DEBUG("m_dataHoppingConfig.hoppingInfo : " << (uint16_t)m_dataHoppingConfig.hoppingInfo
                                                      << " nPrb : " << nPrb);
...
std::vector<std::vector<uint32_t>>
SidelinkCommResourcePool::GetNprbType2(uint8_t rbStart,
                                       uint8_t rbLen,
                                       std::vector<uint32_t> psschSFIndexes)
{
    ...
    std::vector<std::vector<uint32_t>> nPrbVector(psschSFIndexes.size(),
                                                  std::vector<uint32_t>(rbLen, 0));
    ...
    {
        nTildeVrbStart =
            m_rbpsschPoolPrbToVrbIndexMap[rbStart] - std::ceil(m_dataHoppingConfig.rbOffset / 2);
        sbSize = std::floor(
            (m_rbpssch - m_dataHoppingConfig.rbOffset - (m_dataHoppingConfig.rbOffset % 2)) /
    ...
    for (auto it = psschSFIndexes.begin(); it != psschSFIndexes.end(); it++)
    {
        ...
        NS_LOG_LOGIC("SFN: " << *it << ", hopIndex " << (uint16_t)hopIndex
                             << ", hop_distance: " << hop_distance);
        for (uint32_t iVrbGrant = 0; iVrbGrant < rbLen; iVrbGrant++)
        {
            nTildeVrb = nTildeVrbStart + iVrbGrant;

            nPrb = (uint32_t)((nTildeVrb + hop_distance +
                               ((sbSize - 1) - 2 * (uint32_t)(nTildeVrb % sbSize)) * mirroring) %
                              (sbSize * m_dataHoppingConfig.numSubbands));
            ...
            if (mirroring)
            {
                // Re-arrange PRB index, since there is no support yet for mirroring usage of RBs at
                // the spectrum phy, however, a mirrored grant can still benefit from the RB
                // displacement.
                nPrbVector[sf_iter][rbLen - 1 - iVrbGrant] = m_rbpsschVector[nPrb];
                NS_LOG_LOGIC("nTildeVrb " << nTildeVrb << ", nPrbVector[" << sf_iter << "]["
                                          << rbLen - 1 - iVrbGrant
                                          << "]: " << nPrbVector[sf_iter][rbLen - 1 - iVrbGrant]);
            }
            else
            {
                nPrbVector[sf_iter][iVrbGrant] = m_rbpsschVector[nPrb];
                NS_LOG_LOGIC("nTildeVrb " << nTildeVrb << ", nPrbVector[" << sf_iter << "]["
                                          << iVrbGrant << "]: " << nPrbVector[sf_iter][iVrbGrant]);
            }
        }
        sf_iter++;
    }
...
SidelinkCommResourcePool::FHopFunction(uint32_t i)
{
    ...
    {
        NS_FATAL_ERROR(this << " INVALID NUMBER OF SUBBANDS FOR FREQUENCY HOPPING. ONLY VALUES 1, "
                               "2, OR 4 ARE VALID.");
    }
}
...
SidelinkCommResourcePool::GenerateHopSequence()
{
    ...
    for (uint32_t i = 0; i < 10240; i++)
    {
        ...
        else
        {
            ...
            if (m_dataHoppingConfig.numSubbands == 2)
            {
                m_hopSequence.push_back(
                    uint8_t((fhop_prev + sum) % m_dataHoppingConfig.numSubbands));
            }
            else if (m_dataHoppingConfig.numSubbands > 2)
            {
                sum = sum % (m_dataHoppingConfig.numSubbands - 1);
                m_hopSequence.push_back(
                    uint8_t((fhop_prev + sum + 1) % m_dataHoppingConfig.numSubbands));
            }
            else
            {
                NS_FATAL_ERROR(this << " INVALID NUMBER OF SUBBANDS FOR FREQUENCY HOPPING. ONLY "
                                       "VALUES 1, 2, OR 4 ARE VALID.");
            }
        }
...
SidelinkCommResourcePool::ComputeNumberOfPscchResources()
{
    ...
    NS_LOG_DEBUG("L_pscch = " << m_lpscch << ", m_rb = " << m_rbpscch
                              << ", m_nPscchResources = " << m_nPscchResources);
}
...
SidelinkCommResourcePool::ComputeNumberOfPsschResources()
{
    ...
    {
        // 3GPP TS 36.213 14.1.4 UE procedure for determining subframe pool for Sidelink
        // transmission mode 1 all subframes with index greater than lpscch + 1
        for (uint32_t i = m_lpscchVector.at(m_lpscch - 1) + 1;
             i < LteRrcSap::PeriodAsInt(m_scPeriod);
             i++)
        {
    ...
    else if (m_type == SidelinkCommResourcePool::UE_SELECTED)
    {
        // section 14.1.3
        uint32_t b_j;
        for (uint32_t i = m_dataTfResourceConfig.offsetIndicator.offset;
             i < LteRrcSap::PeriodAsInt(m_scPeriod);
             i++)
        {
            b_j = (i - m_dataTfResourceConfig.offsetIndicator.offset) %
                  m_dataTfResourceConfig.subframeBitmap.bitmap.size();
...
TypeId
SidelinkRxCommResourcePool::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SidelinkRxCommResourcePool")
...
TypeId
SidelinkTxCommResourcePool::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SidelinkTxCommResourcePool")
                            .SetParent<SidelinkCommResourcePool>()
...
void
SidelinkTxCommResourcePool::SetScheduledTxParameters(uint16_t slrnti,
                                                     LteRrcSap::SlMacMainConfigSl macMainConfig,
                                                     LteRrcSap::SlCommResourcePool commTxConfig,
                                                     uint8_t index)
{
    NS_LOG_FUNCTION(this);
    m_slrnti = slrnti;
...
SidelinkTxCommResourcePool::operator==(const SidelinkTxCommResourcePool& rhs)
{
    bool equal = m_scTxParameters == rhs.m_scTxParameters &&
                 ...
                 m_poolIdentity == rhs.m_poolIdentity && m_slrnti == rhs.m_slrnti &&
                 m_macMainConfig == rhs.m_macMainConfig && m_commTxConfig == rhs.m_commTxConfig &&
                 m_index == rhs.m_index && m_haveMcs == rhs.m_haveMcs;
    if (equal && m_haveMcs)
    {
...
SidelinkDiscResourcePool::SidelinkDiscResourcePool()
    : m_type(SidelinkDiscResourcePool::UNKNOWN)
{
    NS_LOG_FUNCTION(this);
    m_preconfigured = false;
}
...
TypeId
SidelinkDiscResourcePool::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SidelinkDiscResourcePool")
                            .SetParent<Object>()
...
SidelinkDiscResourcePool::SetPool(LteRrcSap::SlDiscResourcePool pool)
{
    ...
    NS_ABORT_MSG_IF(pool.numRetx > 3,
                    "For discovery maximum number of retransmissions "
                    "should be less than "
                        << (uint16_t)pool.numRetx);
...
SidelinkDiscResourcePool::BuildListOfConflictingResources()
{
    ...
    for (uint32_t i = 0; i < m_nPsdchResources; i++)
    {
        ...
        std::list<SidelinkDiscResourcePool::SidelinkTransmissionInfo> txInfo =
            GetPsdchTransmissions(i);
        // find the list of resources that collide with each of the transmission of resource i by
        // looking at the list of previous resource information
        ...
        for (itNewTx = txInfo.begin(); itNewTx != txInfo.end(); itNewTx++)
        {
            ...
            for (uint32_t j = 0; j < i; j++)
            {
                ...
                for (itPrevTx = txInfoVector.at(j).begin(); itPrevTx != txInfoVector.at(j).end();
                     itPrevTx++)
                {
                    if ((*itNewTx).subframe == (*itPrevTx).subframe)
                    {
                        NS_LOG_DEBUG("    Resource " << j << " collides on subframe "
                                                     << (*itNewTx).subframe.frameNo << "/"
                                                     << (*itNewTx).subframe.subframeNo);
                        // Overlapping subframe
                        if (m_resourceConflictsVector.at(i).find(j) ==
                            m_resourceConflictsVector.at(i).end())
                        {
...
SidelinkDiscResourcePool::GetCurrentDiscPeriod(uint32_t frameNo, uint32_t subframeNo)
{
    ...
    int32_t currentPeriod =
        std::floor((subframe - m_discTfResourceConfig.offsetIndicator.offset) / (double)period);
...
SidelinkDiscResourcePool::GetNextDiscPeriod(uint32_t frameNo, uint32_t subframeNo)
{
    ...
    uint32_t nextStart =
        (m_discTfResourceConfig.offsetIndicator.offset + (currentPeriod + 1) * period);
...
SidelinkDiscResourcePool::GetPsdchTransmissions(uint32_t npsdch)
{
    ...
    uint32_t aj;
    uint32_t b1;
    NS_ABORT_MSG_IF(m_lpsdch < n,
                    "No subframe available for retransmission. Check the discovery bitmap");
...
SidelinkDiscResourcePool::ComputeNumberOfPsdchResources()
{
    ...
    if (m_type == SidelinkDiscResourcePool::UE_SELECTED)
    {
        ...
        uint32_t bj;
        for (uint32_t j = 0;
             j < (m_numRepetition * m_discTfResourceConfig.subframeBitmap.bitmap.size());
             j++)
        {
        ...
        {
            if ((i < m_discTfResourceConfig.prbStart + m_discTfResourceConfig.prbNum) ||
                (i > m_discTfResourceConfig.prbEnd - m_discTfResourceConfig.prbNum))
            {
    ...
    NS_LOG_DEBUG("l_psdch = " << m_lpsdch << ", m_rb = " << m_rbpsdch
                              << ", m_nPsdchResources = " << m_nPsdchResources);
}
...
TypeId
SidelinkRxDiscResourcePool::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SidelinkRxDiscResourcePool")
...
TypeId
SidelinkTxDiscResourcePool::GetTypeId()
{
    static TypeId tid = TypeId("ns3::SidelinkTxDiscResourcePool")
                            .SetParent<SidelinkDiscResourcePool>()
...
SidelinkTxDiscResourcePool::SetPool(LteRrcSap::SlDiscResourcePool pool)
{
    ...
    if (m_type == SidelinkDiscResourcePool::UE_SELECTED)
    {
        ...
        m_havePoolSelectionRsrpBased =
            pool.txParameters.ueSelectedResourceConfig.havePoolSelectionRsrpBased;
        if (pool.txParameters.ueSelectedResourceConfig.havePoolSelectionRsrpBased)
        {
            m_poolSelectionRsrpBased.threshLow =
                pool.txParameters.ueSelectedResourceConfig.poolSelectionRsrpBased.threshLow;
            m_poolSelectionRsrpBased.threshHigh =
...
void
SidelinkTxDiscResourcePool::SetScheduledTxParameters(LteRrcSap::SlDiscResourcePool discPool,
                                                     LteRrcSap::SlTfIndexPairList discResources,
                                                     LteRrcSap::SlHoppingConfigDisc discHopping)
{
    NS_LOG_FUNCTION(this);
...
void
SidelinkTxDiscResourcePool::SetTxProbability(uint32_t theta)
{
    NS_LOG_FUNCTION(this);
