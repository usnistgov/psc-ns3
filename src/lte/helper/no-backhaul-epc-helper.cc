...
void
NoBackhaulEpcHelper::ActivateSidelinkBearer(Ptr<NetDevice> ueDevice, Ptr<LteSlTft> tft)
{
...
void
NoBackhaulEpcHelper::DeactivateSidelinkBearer(Ptr<NetDevice> ueDevice, Ptr<LteSlTft> tft)
{
    NS_LOG_FUNCTION(this << ueDevice);
...
void
NoBackhaulEpcHelper::RemoteUeContextConnected(uint64_t relayImsi,
                                              uint64_t ueImsi,
...
void
NoBackhaulEpcHelper::RemoteUeContextDisconnected(uint64_t relayImsi,
                                                 uint64_t ueImsi,
                                                 uint8_t ipv6Prefix[8])
{
    NS_LOG_FUNCTION(this << relayImsi << ueImsi << ipv6Prefix);
