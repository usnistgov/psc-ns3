...
public:
   ...
   */
  SlOoc1Relay1RemoteMisalignedTestCase (double simTime, double echoClientMaxPackets, double echoClientInterval, double echoClientPacketSize, LteRrcSap::SlPreconfiguration preconfigurationRemote);
  virtual ~SlOoc1Relay1RemoteMisalignedTestCase ();
  /**
...
void
SlOoc1Relay1RemoteMisalignedTestCase::DataPacketSinkTxNode (Ptr<const Packet> p, const Address &src, const Address &dst)
{
...
void
SlOoc1Relay1RemoteMisalignedTestCase::DataPacketSinkRxNode (Ptr<const Packet> p, const Address &src, const Address &dst)
{
...
void
SlOoc1Relay1RemoteMisalignedTestCase::PC5SignalingPacketTraceFunction (uint32_t srcL2Id, uint32_t dstL2Id, Ptr<Packet> p)
{
...
void
SlOoc1Relay1RemoteMisalignedTestCase::DoRun (void)
{
  ...
  NS_TEST_ASSERT_MSG_EQ ((m_recvRUIRq && m_recvRUIRs), false, "Error in sending and receiving RemoteUeInfoRequest and RemoteUeInfoResponse. Test misaligned scenario failed");
  NS_TEST_ASSERT_MSG_EQ ((m_txPacket && m_rxPacket), false, "Atleast one packet was sent and received (echoed) at the Remote UE. Test misaligned scenario failed");
}
