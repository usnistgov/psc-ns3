...
class SlInCovrg1Relay1RemoteDisconnectRemoteTestCase : public TestCase
{
  public:
    ...
    ~SlInCovrg1Relay1RemoteDisconnectRemoteTestCase() override;
    /**
...
void
SlInCovrg1Relay1RemoteDisconnectRemoteTestCase::PC5SignalingPacketTraceFunction(uint32_t srcL2Id,
                                                                                uint32_t dstL2Id,
                                                                                Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteDisconnectRemoteTestCase::DoRun()
{
    ...
    Config::ConnectWithoutContext(
        ...
        MakeCallback(
            &SlInCovrg1Relay1RemoteDisconnectRemoteTestCase::PC5SignalingPacketTraceFunction,
            this));
...
static SlInCovrg1Relay1RemoteDisconnectRemoteTestSuite
    staticSlInCovrg1Relay1RemoteDisconnectRemoteTestSuite;
