...
class SidelinkInCoverageCommTestCase : public TestCase
{
  public:
    ...
    ~SidelinkInCoverageCommTestCase() override;
...
void
SidelinkInCoverageCommTestCase::DoRun()
{
    /**
    ...
    Config::SetDefault("ns3::RrSlFfMacScheduler::SlGrantSize",
    ...
    Config::ConnectWithoutContext(oss.str(),
                                  MakeCallback(&SidelinkInCoverageCommTestCase::SinkRxNode, this));
    //                                        ^
    //                                        |
    // adding more eNB nodes would increase the node id of the receiving UE. Therefore, this number
    // should be incremented if there is more than one eNB.
