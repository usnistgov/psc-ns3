...
class SidelinkOutOfCoverageCommTestCase : public TestCase
{
  public:
    ...
    ~SidelinkOutOfCoverageCommTestCase() override;
...
void
SidelinkOutOfCoverageCommTestCase::DoRun()
{
    /**
    ...
    /*
     ...
     logLevel); LogComponentEnable ("LteUeMac", logLevel); LogComponentEnable ("LteSlPool",
     logLevel);
    */
    ...
    Config::ConnectWithoutContext(
        oss.str(),
        MakeCallback(&SidelinkOutOfCoverageCommTestCase::SinkRxNode, this));
