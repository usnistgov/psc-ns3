...
NS_LOG_COMPONENT_DEFINE("TestSlInCovrg1Relay1RemoteKeepalive");

/**
 * \ingroup lte-test
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote keepalive test case.
 */
class SlInCovrg1Relay1RemoteKeepaliveTestCase : public TestCase
{
  public:
    /**
     * Constructor
     ...
     */
    SlInCovrg1Relay1RemoteKeepaliveTestCase(double simTime);
    ~SlInCovrg1Relay1RemoteKeepaliveTestCase() override;
    /**
  ...
  private:
    ...
    bool m_recvDCK;                   ///< recvDCK
    bool m_recvDCKA;                  ///< recvDCKA
...
SlInCovrg1Relay1RemoteKeepaliveTestCase::~SlInCovrg1Relay1RemoteKeepaliveTestCase()
{
}

void
SlInCovrg1Relay1RemoteKeepaliveTestCase::PC5SignalingPacketTraceFunction(uint32_t srcL2Id,
                                                                         uint32_t dstL2Id,
                                                                         Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteKeepaliveTestCase::DoRun()
{
    ...
    Config::ConnectWithoutContext(
        ...
        MakeCallback(&SlInCovrg1Relay1RemoteKeepaliveTestCase::PC5SignalingPacketTraceFunction,
                     this));
    ...
    NS_TEST_ASSERT_MSG_EQ((m_recvDCK && m_recvDCKA),
                          true,
                          "Error in sending and receiving DirectCommunicationKeepalive and "
                          "DirectCommunicationKeepaliveAck. Test keepalive scenario failed");
}
 ...
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote keepalive test suite.
 */
class SlInCovrg1Relay1RemoteKeepaliveTestSuite : public TestSuite
{
  public:
    SlInCovrg1Relay1RemoteKeepaliveTestSuite();
};
    ...
    : TestSuite("sl-in-covrg-1relay-1remote-keepalive", SYSTEM)
{
    ...
    AddTestCase(new SlInCovrg1Relay1RemoteKeepaliveTestCase(10.0), TestCase::QUICK);
}

static SlInCovrg1Relay1RemoteKeepaliveTestSuite staticSlInCovrg1Relay1RemoteKeepaliveTestSuite;
