...
NS_LOG_COMPONENT_DEFINE("TestSlInCovrg1Relay1RemoteDisconnectRelay");

/**
 * \ingroup lte-test
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote disconnect relay test case.
 */
class SlInCovrg1Relay1RemoteDisconnectRelayTestCase : public TestCase
{
  public:
    /**
     * Constructor
     ...
     */
    SlInCovrg1Relay1RemoteDisconnectRelayTestCase(double simTime);
    ~SlInCovrg1Relay1RemoteDisconnectRelayTestCase() override;
    /**
...
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::SlInCovrg1Relay1RemoteDisconnectRelayTestCase(
    double simTime)
...
void
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::PC5SignalingPacketTraceFunction(uint32_t srcL2Id,
                                                                               uint32_t dstL2Id,
                                                                               Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::DoRun()
{
    ...
    Config::ConnectWithoutContext(
        ...
        MakeCallback(
            &SlInCovrg1Relay1RemoteDisconnectRelayTestCase::PC5SignalingPacketTraceFunction,
            this));
    ...
    NS_TEST_ASSERT_MSG_EQ((m_recvDCR && m_recvDCRA),
                          true,
                          "Error in sending and receiving DirectCommunicationRelease and "
                          "DirectCommunicationReleaseAccept. Test stopping relay service failed");
}
 ...
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote disconnect relay test suite.
 */
class SlInCovrg1Relay1RemoteDisconnectRelayTestSuite : public TestSuite
{
  public:
    SlInCovrg1Relay1RemoteDisconnectRelayTestSuite();
};

SlInCovrg1Relay1RemoteDisconnectRelayTestSuite::SlInCovrg1Relay1RemoteDisconnectRelayTestSuite()
    : TestSuite("sl-in-covrg-1relay-1remote-disconnect-relay", SYSTEM)
{
    // Test stopping relay service
    // Relay UE stops acting as a relay after remote UE is connected.
    // Pass the variables simTime
    AddTestCase(new SlInCovrg1Relay1RemoteDisconnectRelayTestCase(10.0), TestCase::QUICK);
}

static SlInCovrg1Relay1RemoteDisconnectRelayTestSuite
    staticSlInCovrg1Relay1RemoteDisconnectRelayTestSuite;
