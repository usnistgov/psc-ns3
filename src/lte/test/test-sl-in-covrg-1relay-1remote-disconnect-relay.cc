...
public:
  ...
  virtual ~SlInCovrg1Relay1RemoteDisconnectRelayTestCase ();
  /**
...
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::SlInCovrg1Relay1RemoteDisconnectRelayTestCase (double simTime)
...
void
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::PC5SignalingPacketTraceFunction (uint32_t srcL2Id, uint32_t dstL2Id, Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteDisconnectRelayTestCase::DoRun (void)
{
  ...
  if (useRelay)
    {
      ...
      Simulator::Schedule (Seconds (7.0), &LteSidelinkHelper::StopRelayService, proseHelper, ueDevs.Get (0), 33);
    }

  Config::ConnectWithoutContext ("/NodeList/*/DeviceList/*/LteUeRrc/SidelinkConfiguration/PC5SignalingPacketTrace", MakeCallback (&SlInCovrg1Relay1RemoteDisconnectRelayTestCase::PC5SignalingPacketTraceFunction, this));
...
static SlInCovrg1Relay1RemoteDisconnectRelayTestSuite staticSlInCovrg1Relay1RemoteDisconnectRelayTestSuite;
