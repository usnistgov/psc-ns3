...
public:
   ...
   */
  SlInCovrg1Relay1RemoteRegularTestCase (double simTime, double echoClientMaxPackets, double echoClientInterval, double echoClientPacketSize);
  virtual ~SlInCovrg1Relay1RemoteRegularTestCase ();
  /**
...
SlInCovrg1Relay1RemoteRegularTestCase::SlInCovrg1Relay1RemoteRegularTestCase (double simTime, double echoClientMaxPackets, double echoClientInterval, double echoClientPacketSize)
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkTxNode (Ptr<const Packet> p, const Address &src, const Address &dst)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkRxNode (Ptr<const Packet> p, const Address &src, const Address &dst)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction (uint32_t srcL2Id, uint32_t dstL2Id, Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DoRun (void)
{
  ...
  Config::ConnectWithoutContext ("/NodeList/*/DeviceList/*/LteUeRrc/SidelinkConfiguration/PC5SignalingPacketTrace", MakeCallback (&SlInCovrg1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction, this));

  std::ostringstream txWithAddresses;
  txWithAddresses << "/NodeList/" << ueDevs.Get (1)->GetNode ()->GetId () << "/ApplicationList/0/TxWithAddresses";
  Config::ConnectWithoutContext (txWithAddresses.str (), MakeCallback (&SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkTxNode, this));

  std::ostringstream rxWithAddresses;
  rxWithAddresses << "/NodeList/" << ueDevs.Get (1)->GetNode ()->GetId () << "/ApplicationList/0/RxWithAddresses";
  Config::ConnectWithoutContext (rxWithAddresses.str (), MakeCallback (&SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkRxNode, this));
