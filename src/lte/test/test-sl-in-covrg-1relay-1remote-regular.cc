...
NS_LOG_COMPONENT_DEFINE("TestSlInCovrg1Relay1RemoteRegular");

/**
 * \ingroup lte-test
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote regular test case.
 */
class SlInCovrg1Relay1RemoteRegularTestCase : public TestCase
{
  public:
    /**
     * Constructor
     ...
     */
    SlInCovrg1Relay1RemoteRegularTestCase(double simTime,
                                          double echoClientMaxPackets,
                                          double echoClientInterval,
                                          double echoClientPacketSize);
    ~SlInCovrg1Relay1RemoteRegularTestCase() override;
    /**
...
SlInCovrg1Relay1RemoteRegularTestCase::SlInCovrg1Relay1RemoteRegularTestCase(
    double simTime,
    double echoClientMaxPackets,
    double echoClientInterval,
    double echoClientPacketSize)
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkTxNode(Ptr<const Packet> p,
                                                            const Address& src,
                                                            const Address& dst)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkRxNode(Ptr<const Packet> p,
                                                            const Address& src,
                                                            const Address& dst)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction(uint32_t srcL2Id,
                                                                       uint32_t dstL2Id,
                                                                       Ptr<Packet> p)
{
...
void
SlInCovrg1Relay1RemoteRegularTestCase::DoRun()
{
    ...
    Config::ConnectWithoutContext(
        ...
        MakeCallback(&SlInCovrg1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction,
                     this));
    ...
    Config::ConnectWithoutContext(
        txWithAddresses.str(),
        MakeCallback(&SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkTxNode, this));
    ...
    Config::ConnectWithoutContext(
        rxWithAddresses.str(),
        MakeCallback(&SlInCovrg1Relay1RemoteRegularTestCase::DataPacketSinkRxNode, this));
    ...
    NS_TEST_ASSERT_MSG_EQ((m_recvRUIRq && m_recvRUIRs),
                          ...
                          "RemoteUeInfoResponse. Test regular scenario failed");
    NS_TEST_ASSERT_MSG_EQ((m_txPacket && m_rxPacket),
                          true,
                          "Error in sending and receiving (echoing) of atleast one packet at the "
                          "Remote UE. Test regular scenario failed");
}
 ...
 * \ingroup tests
 *
 * \brief Sidelink in-covrg 1-relay 1-remote regular test suite.
 */
class SlInCovrg1Relay1RemoteRegularTestSuite : public TestSuite
{
  public:
    SlInCovrg1Relay1RemoteRegularTestSuite();
};

SlInCovrg1Relay1RemoteRegularTestSuite::SlInCovrg1Relay1RemoteRegularTestSuite()
    : TestSuite("sl-in-covrg-1relay-1remote-regular", SYSTEM)
{
    // Test regular scenario
    // Remote UE detects, connects, and use relay UE to send and receive traffic.
    // Pass the variables simTime, echoClientMaxPackets, echoClientInterval, echoClientPacketSize
    AddTestCase(new SlInCovrg1Relay1RemoteRegularTestCase(10.0, 20, 0.2, 150), TestCase::QUICK);
}

static SlInCovrg1Relay1RemoteRegularTestSuite staticSlInCovrg1Relay1RemoteRegularTestSuite;
