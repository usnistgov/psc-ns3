...
class SlOoc1Relay1RemoteRegularTestCase : public TestCase
{
  public:
     ...
     */
    SlOoc1Relay1RemoteRegularTestCase(double simTime,
                                      double echoClientMaxPackets,
                                      double echoClientInterval,
                                      double echoClientPacketSize);
    ~SlOoc1Relay1RemoteRegularTestCase() override;
    /**
...
SlOoc1Relay1RemoteRegularTestCase::SlOoc1Relay1RemoteRegularTestCase(double simTime,
                                                                     double echoClientMaxPackets,
                                                                     double echoClientInterval,
                                                                     double echoClientPacketSize)
...
void
SlOoc1Relay1RemoteRegularTestCase::DataPacketSinkTxNode(Ptr<const Packet> p,
                                                        const Address& src,
                                                        const Address& dst)
{
...
void
SlOoc1Relay1RemoteRegularTestCase::DataPacketSinkRxNode(Ptr<const Packet> p,
                                                        const Address& src,
                                                        const Address& dst)
{
...
void
SlOoc1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction(uint32_t srcL2Id,
                                                                   uint32_t dstL2Id,
                                                                   Ptr<Packet> p)
{
...
void
SlOoc1Relay1RemoteRegularTestCase::DoRun()
{
    ...
    Config::ConnectWithoutContext(
        ...
        MakeCallback(&SlOoc1Relay1RemoteRegularTestCase::PC5SignalingPacketTraceFunction, this));
    ...
    Config::ConnectWithoutContext(
        txWithAddresses.str(),
        MakeCallback(&SlOoc1Relay1RemoteRegularTestCase::DataPacketSinkTxNode, this));
    ...
    Config::ConnectWithoutContext(
        rxWithAddresses.str(),
        MakeCallback(&SlOoc1Relay1RemoteRegularTestCase::DataPacketSinkRxNode, this));
