...
latex_documents = [
  ('index', 'ns3-psc-documentation.tex', u'ns-3 Public Safety Communications documentation',
   u'National Institute of Standards and Technology (NIST)', 'manual'),
]
...
man_pages = [
    ('index', 'ns-3 PSC documentation', u'ns-3 PSC documentation',
     [u'ns-3 project'], 1)
]
